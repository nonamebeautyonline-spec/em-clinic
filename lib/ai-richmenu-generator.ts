...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2500 1686">
  ...
  <!-- カード内: 円形アイコン背景 -->
  <circle cx="416" cy="330" r="80" fill="[アクセント色薄]" opacity="0.15"/>
  <!-- カード内: アイコン -->
  <g transform="translate(416,330)">
    <!-- ここにアイコンSVG（stroke=[アクセント色], fill=none, stroke-width=5-6） -->
  </g>
  <!-- カード内: メインラベル -->
  <text x="416" y="490" text-anchor="middle" fill="#1F2937" font-size="52" font-weight="bold" font-family="'Hiragino Sans','Yu Gothic','Noto Sans JP',sans-serif">予約</text>
  <!-- カード内: サブラベル -->
  <text x="416" y="545" text-anchor="middle" fill="#9CA3AF" font-size="32" font-family="'Hiragino Sans','Yu Gothic','Noto Sans JP',sans-serif">RESERVATION</text>
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2500 1686">
  ...
  <g transform="translate(416,350)">
    ...
    <!-- ラベル -->
    <text x="0" y="150" text-anchor="middle" fill="white" font-size="52" font-weight="bold" font-family="'Hiragino Sans','Yu Gothic','Noto Sans JP',sans-serif">ラベル1</text>
    <!-- サブラベル（英語） -->
    <text x="0" y="200" text-anchor="middle" fill="rgba(255,255,255,0.7)" font-size="28" font-family="'Hiragino Sans','Yu Gothic','Noto Sans JP',sans-serif">LABEL</text>
  </g>
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2500 1686">
  ...
  <!-- カード1: アイコン + ラベル -->
  <circle cx="321" cy="1270" r="65" fill="[アクセント薄]" opacity="0.12"/>
  <g transform="translate(321,1270)">
    <!-- アイコン -->
  </g>
  <text x="321" y="1430" text-anchor="middle" fill="#1F2937" font-size="44" font-weight="bold" font-family="'Hiragino Sans','Yu Gothic','Noto Sans JP',sans-serif">ラベル</text>
  <text x="321" y="1475" text-anchor="middle" fill="#9CA3AF" font-size="26" font-family="'Hiragino Sans','Yu Gothic','Noto Sans JP',sans-serif">LABEL</text>
