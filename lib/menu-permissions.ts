...
export const MENU_ITEMS: MenuDef[] = [
  ...
  { key: "campaigns", label: "キャンペーン", section: "業務管理", paths: ["/admin/campaigns"] },
  { key: "coupons", label: "クーポン", section: "業務管理", paths: ["/admin/coupons"] },
  { key: "subscription_plans", label: "定期プラン", section: "業務管理", paths: ["/admin/subscription-plans"] },
