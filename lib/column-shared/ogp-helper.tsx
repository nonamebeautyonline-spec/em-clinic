...
const categoryColors: Record<string, { bg: string; text: string; dot: string }> = {
  ...
  /* 汎用LINE向けカテゴリ */
  "LINE公式アカウント入門": { bg: "rgba(59,130,246,0.1)", text: "#1d4ed8", dot: "#3b82f6" },
  "ツール比較・選定": { bg: "rgba(168,85,247,0.1)", text: "#7c3aed", dot: "#a855f7" },
  "配信・メッセージング": { bg: "rgba(16,185,129,0.1)", text: "#047857", dot: "#10b981" },
  "リッチメニュー・UI設計": { bg: "rgba(236,72,153,0.1)", text: "#be185d", dot: "#ec4899" },
  "自動化・効率化": { bg: "rgba(245,158,11,0.1)", text: "#b45309", dot: "#f59e0b" },
  "業種別活用事例": { bg: "rgba(6,182,212,0.1)", text: "#0e7490", dot: "#06b6d4" },
  "分析・改善": { bg: "rgba(244,63,94,0.1)", text: "#be123c", dot: "#f43f5e" },
  "成功事例・ノウハウ": { bg: "rgba(249,115,22,0.1)", text: "#c2410c", dot: "#f97316" },
};
 ...
 * @param brandName ブランド名（例: "Lオペ for CLINIC", "Lオペ"）
 */
export function generateColumnOGP(params: {
  ...
  const { title, category, description, brandName = "Lオペ for CLINIC" } = params;
