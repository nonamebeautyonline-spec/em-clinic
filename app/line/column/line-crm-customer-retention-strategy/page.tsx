...
const faqItems = [
  { q: "LINE公式アカウントをCRMとして活用するメリットは？", a: "既存のCRMツール（Salesforce等）と比較して、顧客への情報到達率が非常に高い点が最大のメリットです。メールCRMの開封率15〜25%に対し、LINEは60〜80%。また双方向コミュニケーションが気軽にでき、顧客の声をリアルタイムに収集できます。" },
      ...
      <section>
        ...
        <Callout type="point" title="LINEがCRMに最適な3つの理由">
          <ol className="list-decimal pl-4 space-y-1 mt-1">
            <li><strong>到達率の高さ</strong> — メールの3〜7倍の開封率で確実にメッセージが届く</li>
