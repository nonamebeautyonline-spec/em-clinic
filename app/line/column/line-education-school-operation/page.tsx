...
const faqItems = [
  { q: "学習塾でLINE公式アカウントを活用する最大のメリットは？", a: "保護者への連絡手段として圧倒的な到達率があります。メールは見落とされがちですが、LINEなら開封率80%以上で、欠席連絡・成績報告・面談予約などがスムーズに行えます。また体験授業の予約受付をLINE化することで、問い合わせのハードルが下がり集客にも直結します。" },
