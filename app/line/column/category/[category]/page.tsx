...
const categoryStyles: Record<string, string> = {
  "LINE公式アカウント入門": "bg-blue-50 text-blue-600 ring-blue-200/50",
  "ツール比較・選定":       "bg-violet-50 text-violet-600 ring-violet-200/50",
  "配信・メッセージング":   "bg-rose-50 text-rose-600 ring-rose-200/50",
  "リッチメニュー・UI設計": "bg-cyan-50 text-cyan-600 ring-cyan-200/50",
  "自動化・効率化":         "bg-teal-50 text-teal-600 ring-teal-200/50",
  "業種別活用事例":         "bg-orange-50 text-orange-600 ring-orange-200/50",
  "分析・改善":             "bg-yellow-50 text-yellow-700 ring-yellow-200/50",
  "成功事例・ノウハウ":     "bg-emerald-50 text-emerald-600 ring-emerald-200/50",
};
        ...
        <header className="sticky top-0 z-30 border-b border-gray-200/60 bg-white/95 backdrop-blur-md">
          <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-3.5">
            ...
            <div className="flex items-center gap-6">
              ...
              <Link href="/line/column" className="hidden text-[14px] font-medium text-blue-600 md:block">
                コラム
              </Link>
              <Link
                href="/line/contact"
        ...
        <div className="border-b border-gray-200 bg-white">
          <nav aria-label="パンくずリスト" className="mx-auto max-w-7xl px-6 py-3">
            <ol className="flex items-center gap-2 text-[13px] text-gray-400 list-none m-0 p-0">
              <li>
                <Link href="/line" className="hover:text-blue-600 transition">
                  トップ
                </Link>
              </li>
              ...
              <li>
                <Link href="/line/column" className="hover:text-blue-600 transition">
                  コラム
                </Link>
              </li>
              <li aria-hidden="true" className="text-gray-300">
          ...
          <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 3, name: cat.label, item: `https://l-ope.jp/line/column/category/${cat.slug}` },
            ],
          }) }} />
        </div>
          ...
          <div className="mx-auto flex max-w-7xl flex-wrap items-center gap-2.5 pb-5">
            ...
            {categories.map((c) => {
              ...
              return (
                <Link
                  key={c.slug}
                  href={`/line/column/category/${c.slug}`}
          ...
          <div className="mx-auto max-w-7xl px-6">
            <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-between">
              ...
              <div className="flex items-center gap-6">
                ...
                <Link href="/line/column" className="text-[13px] text-blue-600 font-medium">
                  コラム
                </Link>
              </div>
            </div>
