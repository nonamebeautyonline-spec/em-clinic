      ...
      <div className="mx-auto max-w-6xl">
        <div className="flex flex-col items-center justify-between gap-5 md:flex-row">
          ...
          <nav aria-label="フッターナビゲーション" className="flex flex-wrap justify-center gap-6 text-[12px]">
            <Link href="/line/about" className="hover:text-white">Lオペとは</Link>
            ...
            <Link href="/line/features" className="hover:text-white">機能一覧</Link>
            <Link href="/line/column" className="hover:text-white">コラム</Link>
            <Link href="/line/contact" className="hover:text-white">お問い合わせ</Link>
