...
export function Label({ children }: { children: React.ReactNode }) {
  return <span className="mb-4 inline-block rounded-full bg-emerald-50 px-4 py-1.5 text-[11px] font-semibold tracking-[.18em] text-emerald-600 uppercase">{children}</span>;
}
