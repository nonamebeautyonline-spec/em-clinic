  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        question: "電話番号を変更したい",
        answer:
          "電話番号の変更はLINEメッセージでスタッフにお知らせください。本人確認のうえ、変更の手続きをいたします。",
      },
      {
        question: "登録した個人情報を修正したい",
        answer:
          "氏名・住所などの個人情報の修正は、LINEメッセージでスタッフにお知らせください。確認のうえ修正いたします。",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "銀行振込の場合、次回発送の直前に入金確認を行います。お振込み後、特に連絡の必要はありません。\n\nクレジットカード決済の場合は、決済完了と同時に自動で確認されます。",
      },
      {
