...
const faqs: { q: string; a: string; rich?: ReactNode }[] = [
  ...
  { q: "導入後のサポート体制を教えてください。", a: "専任の担当者が初期設定から運用開始後のフォローまで伴走します。LINE配信の企画相談やリッチメニューの改善提案など、運用面でもサポートいたします。" },
  {
    ...
    rich: <span className="mt-1.5 block"><Link href="/clinic/column/lstep-vs-clinic-tool" className="text-blue-500 hover:underline">→ Lステップ vs クリニック専用ツールの詳しい比較はこちら</Link></span>,
  },
  {
    q: "美容クリニックや歯科でも使えますか？",
    a: "はい。美容クリニック・歯科・皮膚科・内科など、あらゆる診療科でご利用いただけます。カウンセリング予約・定期検診リマインド・処方薬配送など、診療科ごとの業務フローに合わせた活用が可能です。",
    rich: <span className="mt-1.5 block"><Link href="/clinic/column/beauty-clinic-line" className="text-blue-500 hover:underline">→ 美容クリニックのLINE活用事例を見る</Link></span>,
  },
