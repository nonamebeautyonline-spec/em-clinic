...
const categoryColumnLinks: Record<string, { href: string; label: string }> = {
  line: { href: "/clinic/column/segment-delivery-repeat", label: "LINEセグメント配信でリピート率を向上させる方法" },
  ai: { href: "/clinic/column/ai-auto-reply-guide", label: "AI自動返信導入ガイド" },
  clinic: { href: "/clinic/column/reservation-system-comparison", label: "クリニック予約システム比較10選" },
  payment: { href: "/clinic/column/dermatology-clinic-line", label: "皮膚科の処方薬配送とフォローアップ自動化" },
  analytics: { href: "/clinic/column/clinic-kpi-dashboard", label: "LINEダッシュボードで見るべきKPI7選" },
};
