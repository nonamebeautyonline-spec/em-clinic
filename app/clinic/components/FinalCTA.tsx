    ...
    <section id="contact" className="bg-gradient-to-br from-blue-500 via-sky-500 to-blue-400 px-5 py-24 md:py-32">
      <FadeIn className="mx-auto max-w-3xl text-center">
        ...
        <div className="flex flex-col items-center justify-center gap-3 sm:flex-row">
          <a href="/clinic/contact?ref=lp" className="w-full rounded-xl bg-white px-10 py-4 text-[13px] font-bold text-blue-700 shadow-lg transition hover:bg-blue-50 sm:w-auto">無料で資料請求・お問い合わせ</a>
        </div>
