  ...
  return (
    <ArticleLayout slug={self.slug} breadcrumbLabel="医薬品解説" keyPoints={keyPoints} toc={[]}>
      ...
      <section>
        ...
        <p>エビデンスの読み方に興味がある方は、<Link href="/clinic/column/glp1-diet-safety-evidence" className="text-sky-600 underline hover:text-sky-800">GLP-1ダイエットのエビデンス解説</Link>も参考になります。臨床データの見方が身につくと、こうした情報の判断力がぐっと上がりますよ。</p>
      </section>
      ...
      <section>
        ...
        <p>催奇形性以外にも、知っておくべき副作用があります。副作用管理の考え方については<Link href="/clinic/column/mounjaro-side-effects-guide" className="text-sky-600 underline hover:text-sky-800">マンジャロの副作用ガイド</Link>にも共通するポイントがあるので、あわせて読んでみてください。</p>
