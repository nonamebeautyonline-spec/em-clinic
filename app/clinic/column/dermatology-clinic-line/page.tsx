...
const self = articles.find((a) => a.slug === "dermatology-clinic-line")!;
  ...
  return (
    <ArticleLayout slug={self.slug} breadcrumbLabel="皮膚科LINE活用" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <p>皮膚科はオンライン診療との相性が非常に良い診療科です。オンライン診療とLINEの連携について詳しくは<Link href="/clinic/column/online-medical-line" className="text-blue-600 underline">オンライン診療×LINEの活用法</Link>もあわせてご覧ください。特に再診では、患者が<strong>LINEで患部の写真を送信する</strong>だけで診察が完結するケースが多くあります。</p>
        <FlowSteps steps={[
