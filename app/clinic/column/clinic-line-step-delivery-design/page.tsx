  ...
  return (
    <ArticleLayout slug={self.slug} breadcrumbLabel="マーケティング" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <p>一斉配信と異なり、ステップ配信は患者ごとの「起点日」に基づいて個別にメッセージが送信されるため、タイミングの合ったフォローが可能です。<Link href="/clinic/column/segment-delivery-repeat" className="text-sky-600 underline hover:text-sky-800">セグメント配信によるリピート率向上</Link>と組み合わせることで、さらに効果を高められます。</p>
      </section>
      ...
      <section>
        ...
        <p>離脱防止シナリオのポイントは、<strong>「なぜ来院が必要か」を患者目線で伝える</strong>ことです。単なる予約案内ではなく、治療を中断した場合のリスクや、継続することで期待できる効果を具体的に伝えることで、患者自身が来院の意思決定をしやすくなります。<Link href="/clinic/column/clinic-patient-retention" className="text-sky-600 underline hover:text-sky-800">患者リテンション戦略の記事</Link>でも詳しく解説しています。</p>
      ...
      <section>
        ...
        <p><Link href="/clinic/column/clinic-line-automation" className="text-sky-600 underline hover:text-sky-800">LINE自動化ガイド</Link>と合わせて活用することで、配信業務のほぼ全てを自動化できます。</p>
      </section>
