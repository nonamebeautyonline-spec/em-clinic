  ...
  return (
    <ArticleLayout slug={self.slug} breadcrumbLabel="マーケティング" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <p>友だち追加後の導線設計については<Link href="/clinic/column/clinic-line-friends-growth" className="text-sky-600 underline hover:text-sky-800">LINE友だち増加施策の記事</Link>でも詳しく解説しています。</p>
      </section>
      ...
      <section>
        ...
        <Callout type="success" title="オンライン診療×LAPの好相性">
          オンライン診療はLINE上で予約・問診・決済・配送通知まで完結できるため、友だち追加からの患者体験がシームレスです。<Link href="/clinic/column/self-pay-clinic-ad-roi" className="text-sky-600 underline hover:text-sky-800">自費クリニックの広告ROI改善</Link>や<Link href="/clinic/column/online-clinic-marketing-guide" className="text-sky-600 underline hover:text-sky-800">オンラインクリニックのマーケティング戦略</Link>と併せて、広告投資の全体最適を図りましょう。
        </Callout>
      </section>
