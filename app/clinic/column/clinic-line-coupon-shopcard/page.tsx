...
const faqItems = [
  { q: "クリニックのLINEクーポン・ショップカード活用術の効果はどのくらいで実感できますか？", a: "施策にもよりますが、LINE配信やSEO対策は1〜3ヶ月で効果が出始めるケースが多いです。特にセグメント配信は導入直後から開封率・クリック率の改善が見られます。継続的な改善サイクルを回すことで、半年後には大きな成果に繋がります。" },
  ...
  return (
    <ArticleLayout slug={self.slug} breadcrumbLabel="マーケティング" keyPoints={keyPoints} toc={toc}>
      ...
      <p className="text-[15px] leading-relaxed text-gray-700 font-medium bg-blue-50 rounded-xl p-5 border border-blue-100">
        ...
        紹介制度との連携については<Link href="/clinic/column/clinic-referral-program" className="text-sky-600 underline hover:text-sky-800">LINE紹介プログラムの設計ガイド</Link>もご覧ください。
      </p>
      ...
      <section>
        ...
        <p>
          自費クリニックのLTV最大化の全体戦略については<Link href="/clinic/column/self-pay-clinic-ltv-maximize" className="text-sky-600 underline hover:text-sky-800">自費クリニックのLTV最大化ガイド</Link>で詳しく解説しています。
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          ...
          季節キャンペーンの設計については<Link href="/clinic/column/clinic-seasonal-campaign" className="text-sky-600 underline hover:text-sky-800">クリニックの季節キャンペーン設計ガイド</Link>も併せてご確認ください。
        </p>
      </section>
