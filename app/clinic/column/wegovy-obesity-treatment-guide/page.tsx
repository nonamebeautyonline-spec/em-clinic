  ...
  return (
    <ArticleLayout slug={self.slug} breadcrumbLabel="医薬品解説" keyPoints={keyPoints} toc={[]}>
      ...
      <section>
        ...
        <p>よく誤解されるのが、「オゼンピックを肥満で保険処方してもらえないか」という質問。答えは<strong>NO</strong>です。オゼンピックの保険適用はあくまで2型糖尿病。肥満症で保険が使えるのはウゴービだけです。一方、自費クリニックではオゼンピックやリベルサスをダイエット目的で処方するケースがありますが、これは<strong>適応外使用</strong>であり保険は効きません。各薬剤の詳細な比較は<Link href="/clinic/column/glp1-medication-comparison" className="text-sky-600 underline hover:text-sky-800">GLP-1薬剤比較ガイド</Link>をご覧ください。</p>
      </section>
      ...
      <section>
        ...
        <Callout type="point" title="関連記事もあわせてどうぞ">
          GLP-1受容体作動薬の<strong>基本的な仕組み</strong>については<Link href="/clinic/column/glp1-medication-guide" className="text-emerald-700 underline">「GLP-1受容体作動薬とは」</Link>、<strong>安全性エビデンス</strong>については<Link href="/clinic/column/glp1-diet-safety-evidence" className="text-emerald-700 underline">「GLP-1ダイエットは危険？」</Link>、肥満症治療の<strong>最新動向</strong>については<Link href="/clinic/column/obesity-treatment-trends-2026" className="text-emerald-700 underline">「肥満症治療の最新動向」</Link>をご覧ください。また、同じGIP/GLP-1デュアル作動薬の肥満症適応である<strong>ゼップバウンド</strong>については<Link href="/clinic/column/zepbound-obesity-treatment-guide" className="text-emerald-700 underline">ゼップバウンド完全ガイド</Link>で詳しく解説しています。
        </Callout>
      </section>
