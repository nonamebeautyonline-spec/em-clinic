  ...
  return (
    <ArticleLayout slug={self.slug} breadcrumbLabel="マーケティング" keyPoints={keyPoints} toc={toc}>
      ...
      <p className="text-[15px] leading-relaxed text-gray-700 font-medium bg-blue-50 rounded-xl p-5 border border-blue-100">
        ...
        配信効果測定の基本は<Link href="/clinic/column/clinic-line-analytics" className="text-sky-600 underline hover:text-sky-800">LINE配信効果測定の完全ガイド</Link>も併せてご確認ください。
      </p>
      ...
      <section>
        ...
        <p>
          ...
          セグメント配信と組み合わせる方法は<Link href="/clinic/column/segment-delivery-repeat" className="text-sky-600 underline hover:text-sky-800">セグメント配信でリピート率を向上させる方法</Link>で解説しています。
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          ...
          リピート率の改善施策は<Link href="/clinic/column/clinic-repeat-rate-improvement" className="text-sky-600 underline hover:text-sky-800">クリニックのリピート率改善ガイド</Link>も参考になります。
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          ...
          LINE運用全体の設計については<Link href="/clinic/column/clinic-line-analytics" className="text-sky-600 underline hover:text-sky-800">LINE配信効果測定の完全ガイド</Link>も併せてご確認ください。
        </p>
      </section>
