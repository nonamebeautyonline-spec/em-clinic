  ...
  return (
    <ArticleLayout slug={self.slug} breadcrumbLabel="活用事例" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <p>
          アトピー性皮膚炎の<strong>画像評価のポイント</strong>は、照明条件の統一（自然光・同じ角度）、同一部位の経時的比較、スケール（定規等）の併置です。患者に「毎回同じ条件で撮影してください」と指導し、LINEで写真を提出してもらうことで、<strong>経時的な改善・増悪を正確に評価</strong>できます。オンライン診療における<Link href="/clinic/column/online-clinic-medical-record-guide" className="text-sky-600 underline hover:text-sky-800">カルテ記載のポイント</Link>も併せて確認しておくとよいでしょう。
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          管理患者80人の場合、<strong>月間約43万円の収益</strong>が見込めます。アトピー性皮膚炎は患者数が多く、特に小児患者を含めると一家族で複数人が通院するケースも珍しくありません。オンライン診療で通院負担を軽減することで、<strong>家族全員の継続管理が可能</strong>になります。皮膚科のLINE活用については<Link href="/clinic/column/dermatology-clinic-line" className="text-sky-600 underline hover:text-sky-800">皮膚科クリニックのLINE活用ガイド</Link>も参考にしてください。
        </p>
      </section>
      ...
      <section>
        ...
        <ul className="space-y-1 text-gray-700">
          <li>
            <Link href="/clinic/column/dermatology-clinic-line" className="text-sky-600 underline hover:text-sky-800">皮膚科クリニックのLINE活用ガイド</Link> — 皮膚科領域のLINE運用ノウハウ
          </li>
          <li>
            <Link href="/clinic/column/hyperhidrosis-online-clinic-guide" className="text-sky-600 underline hover:text-sky-800">多汗症のオンライン診療ガイド</Link> — 皮膚科のもうひとつのオンライン診療領域
          </li>
          <li>
          ...
          <li>
            <Link href="/clinic/column/clinic-repeat-rate-improvement" className="text-sky-600 underline hover:text-sky-800">リピート率改善ガイド</Link> — 慢性疾患の治療継続率を向上させるノウハウ
          </li>
          <li>
            <Link href="/clinic/contact" className="text-sky-600 underline hover:text-sky-800">無料相談・お問い合わせ</Link> — アトピー性皮膚炎のオンライン管理体制をご相談いただけます
          </li>
        </ul>
      </section>
