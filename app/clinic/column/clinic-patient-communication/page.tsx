  ...
  return (
    <ArticleLayout slug={self.slug} breadcrumbLabel="ガイド" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <p><Link href="/clinic/column/segment-delivery-repeat" className="text-sky-600 underline hover:text-sky-800">セグメント配信によるリピート率向上</Link>では、パーソナライズ配信の具体的な設定方法を詳しく解説しています。</p>
      ...
      <section>
        ...
        <p><Link href="/clinic/column/clinic-ai-reply-guide" className="text-sky-600 underline hover:text-sky-800">AI返信活用ガイド</Link>では、AIを活用した双方向コミュニケーションの設定方法を詳しく解説しています。</p>
      ...
      <section>
        ...
        <p>診察後のフォローアップは、患者の満足度と再診率を左右する重要なタッチポイントです。<Link href="/clinic/column/line-block-rate-reduction" className="text-sky-600 underline hover:text-sky-800">ブロック率を下げる配信の鉄則</Link>を守りながら、適切なフォローを行いましょう。</p>
