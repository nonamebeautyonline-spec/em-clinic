  ...
  return (
    <ArticleLayout slug={self.slug} breadcrumbLabel="活用事例" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <p>
          管理患者60人の場合、<strong>月間約45万円の収益</strong>が見込めます。喘息は特定疾患療養管理料（情報通信機器：100点）が算定可能であるため、再診料に上乗せした診療報酬が得られます。患者数が100人に達すれば月間約73万円となり、<strong>安定した経営基盤</strong>を構築できます。花粉症のオンライン診療と組み合わせれば、<Link href="/clinic/column/hay-fever-online-clinic-lope" className="text-sky-600 underline hover:text-sky-800">アレルギー疾患全体でより広い患者層をカバー</Link>できます。オンライン診療全般の<Link href="/clinic/column/online-clinic-pricing-breakdown" className="text-sky-600 underline hover:text-sky-800">料金相場と費用構造</Link>も参考にしてください。
        </p>
      </section>
      ...
      <section>
        ...
        <ul className="space-y-1 text-gray-700">
          <li>
            <Link href="/clinic/column/hay-fever-online-clinic-lope" className="text-sky-600 underline hover:text-sky-800">花粉症のオンライン診療ガイド</Link> — アレルギー疾患のもうひとつの柱
          </li>
          <li>
            <Link href="/clinic/column/internal-medicine-line" className="text-sky-600 underline hover:text-sky-800">内科クリニックのLINE活用ガイド</Link> — 内科領域のLINE運用ノウハウ
          </li>
          <li>
          ...
          <li>
            <Link href="/clinic/contact" className="text-sky-600 underline hover:text-sky-800">無料相談・お問い合わせ</Link> — 喘息のオンライン管理体制をご相談いただけます
          </li>
        </ul>
      </section>
