    ...
    <>
      <ArticleLayout slug={self.slug} breadcrumbLabel="オンライン診療の集患・マーケティング完全ガイド" keyPoints={keyPoints} toc={toc}>
        ...
        <section>
          ...
          <p>医療広告ガイドラインの詳細については、<Link href="/clinic/column/clinic-ad-yakki-ho-guide" className="text-emerald-700 underline">クリニック広告と薬機法ガイド</Link>や<Link href="/clinic/column/online-clinic-regulations" className="text-emerald-700 underline">オンライン診療の法規制と薬機法</Link>でさらに詳しく解説しています。</p>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc pl-6 space-y-1">
            <li><Link href="/clinic/column/online-clinic-complete-guide" className="text-emerald-700 underline">オンライン診療完全ガイド — 開業準備・システム選定・集患・運用まで</Link></li>
            <li><Link href="/clinic/column/online-clinic-regulations" className="text-emerald-700 underline">オンライン診療の法規制と薬機法 — 最新ルールと注意点</Link></li>
            <li><Link href="/clinic/column/clinic-ad-yakki-ho-guide" className="text-emerald-700 underline">クリニック広告と薬機法ガイド</Link></li>
            ...
            <li><Link href="/clinic/column/clinic-google-review" className="text-emerald-700 underline">クリニックのGoogle口コミ対策</Link></li>
          </ul>
        </section>
      </ArticleLayout>
    </>
