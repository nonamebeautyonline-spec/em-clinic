    ...
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(jsonLd) }} />
        ...
        <section>
          ...
          <p>リピート施策の詳細な設計方法については<Link href="/clinic/column/clinic-repeat-rate-improvement" className="text-sky-600 underline hover:text-sky-800">クリニックのリピート率改善ガイド</Link>も参考にしてください。</p>
        </section>
        ...
        <section>
          ...
          <p>医療広告規制の全体像については<Link href="/clinic/column/clinic-ad-yakki-ho-guide" className="text-sky-600 underline hover:text-sky-800">薬機法・医療広告ガイドラインのガイド</Link>で詳しく解説しています。</p>
          ...
          <p>LINE広告でクリニックの公式アカウントへの友だち追加を促進します。CPA約4,000円で、友だち追加後にLINE上でナーチャリングができるため、即座に受診しない潜在層も後日の予約につなげられます。セグメント配信と組み合わせることで、友だち追加から初回予約への転換率を高めます。LINE集患の全体設計は<Link href="/clinic/column/clinic-line-revenue-growth" className="text-sky-600 underline hover:text-sky-800">クリニックの売上を上げるLINE活用術</Link>で解説しています。</p>
        </section>
        ...
        <section>
          ...
          <p>DXによるクリニックの業務効率化の全体像は<Link href="/clinic/column/clinic-dx-complete-guide" className="text-sky-600 underline hover:text-sky-800">クリニックDX完全ガイド</Link>で詳しく解説しています。</p>
        </section>
        ...
        <section>
          ...
          <p>自費診療の収益戦略全般については<Link href="/clinic/column/self-pay-clinic-revenue-triple" className="text-sky-600 underline hover:text-sky-800">自費診療の売上を3倍にする方法</Link>も参考にしてください。</p>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc pl-6 space-y-1">
            <li><Link href="/clinic/column/ed-online-clinic-lope" className="text-sky-600 underline hover:text-sky-800">ED治療のオンライン診療ガイド — 匿名性とLINE予約で患者獲得を最大化</Link></li>
            <li><Link href="/clinic/column/online-clinic-complete-guide" className="text-sky-600 underline hover:text-sky-800">オンライン診療の完全ガイド</Link></li>
            <li><Link href="/clinic/column/self-pay-pricing-guide" className="text-sky-600 underline hover:text-sky-800">自費診療の価格設定ガイド</Link></li>
            <li><Link href="/clinic/column/clinic-fixed-cost-optimization" className="text-sky-600 underline hover:text-sky-800">クリニックの固定費最適化ガイド</Link></li>
            <li><Link href="/clinic/column/clinic-dx-complete-guide" className="text-sky-600 underline hover:text-sky-800">クリニックDX完全ガイド</Link></li>
            <li><Link href="/clinic/contact" className="text-sky-600 underline hover:text-sky-800">お問い合わせ・無料相談</Link></li>
          </ul>
        </section>
