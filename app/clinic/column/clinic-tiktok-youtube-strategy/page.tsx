  ...
  return (
    <ArticleLayout slug={self.slug} breadcrumbLabel="マーケティング" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <p>医療広告ガイドラインの詳細については<Link href="/clinic/column/medical-ad-guideline-compliance" className="text-sky-600 underline hover:text-sky-800">医療広告ガイドライン完全ガイド</Link>で網羅的に解説しています。</p>
      </section>
      ...
      <section>
        ...
        <p>この導線を構築することで、「動画を見た→なんとなくフォローした」という弱い関心を、「LINE友だち→問診→予約→来院」という強いコンバージョンに変換できます。Instagramとの連携戦略については<Link href="/clinic/column/self-pay-clinic-instagram-strategy" className="text-sky-600 underline hover:text-sky-800">自費クリニックのInstagram活用ガイド</Link>もご覧ください。</p>
      </section>
