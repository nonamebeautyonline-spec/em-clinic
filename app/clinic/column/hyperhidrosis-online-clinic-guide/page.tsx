    ...
    <ArticleLayout slug={self.slug} breadcrumbLabel="活用事例" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <ul className="space-y-1 text-gray-700">
          ...
          <li>
            <Link href="/clinic/column/self-pay-online-revenue-by-specialty" className="text-sky-600 underline hover:text-sky-800">診療科別オンライン自費収益ガイド</Link> — 多汗症を含む各科の収益戦略
          </li>
          <li>
            <Link href="/clinic/contact" className="text-sky-600 underline hover:text-sky-800">無料相談・お問い合わせ</Link> — 多汗症オンライン外来の運用設計をご相談いただけます
          </li>
        </ul>
      </section>
