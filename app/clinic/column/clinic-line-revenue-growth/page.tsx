...
const faqItems = [
  { q: "LINE導入でクリニックの売上はどのくらい上がりますか？", a: "再診率向上による売上増加が期待できます。規模や診療科によりますが、LINE施策の活用度合いに応じて大きなリターンが見込めます。" },
    ...
    <>
      ...
      <ArticleLayout slug={self.slug} breadcrumbLabel="クリニックの売上を上げるLINE活用術" keyPoints={keyPoints} toc={toc}>
        ...
        <section>
          ...
          <p>セグメント配信による再診促進の詳しいノウハウは<Link href="/clinic/column/segment-delivery-repeat" className="text-emerald-700 underline">LINEセグメント配信でリピート率を向上させる方法</Link>で解説しています。また、患者離脱を防ぐための具体策は<Link href="/clinic/column/clinic-patient-retention" className="text-emerald-700 underline">クリニックの患者離脱を防ぐLINEフォローアップ戦略</Link>もご覧ください。</p>
        </section>
        ...
        <section>
          ...
          <p>LINE友だち集めの具体的な施策については<Link href="/clinic/column/clinic-line-friends-growth" className="text-emerald-700 underline">クリニックのLINE友だち集め — 月100人増やす7つの施策</Link>で詳しく解説しています。また、LINE導入のROI計算方法は<Link href="/clinic/column/clinic-line-roi" className="text-emerald-700 underline">クリニックのLINE公式アカウント導入ROI</Link>を参考にしてください。</p>
        </section>
        ...
        <section>
          ...
          <p>3施策を合計すると、<strong>年間で約1,100万円以上の収益改善</strong>が見込めます。これはLINEという患者接点を戦略的に活用した結果であり、特別な設備投資や人員増強は不要です。経営KPIの管理方法は<Link href="/clinic/column/clinic-kpi-dashboard" className="text-sky-600 underline hover:text-sky-800">LINEダッシュボードで見るべきKPI7選</Link>、自費診療の売上を伸ばす具体策は<Link href="/clinic/column/clinic-self-pay-revenue" className="text-sky-600 underline hover:text-sky-800">自費診療売上向上ガイド</Link>もあわせてご覧ください。</p>
          ...
          <ul className="list-disc pl-6 space-y-1">
            <li><Link href="/clinic/column/segment-delivery-repeat" className="text-emerald-700 underline">LINEセグメント配信でリピート率を向上させる方法</Link></li>
            <li><Link href="/clinic/column/clinic-line-friends-growth" className="text-emerald-700 underline">クリニックのLINE友だち集め — 月100人増やす7つの施策</Link></li>
