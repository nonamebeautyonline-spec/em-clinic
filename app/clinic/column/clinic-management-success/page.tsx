    ...
    <ArticleLayout slug={self.slug} breadcrumbLabel="ガイド" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <Callout type="info" title="開業資金の目安">
          クリニックの開業には5,000万〜1億円程度の資金が必要です。自己資金に加え、日本政策金融公庫の融資を活用するのが一般的です。資金調達の詳細は<Link href="/clinic/column/clinic-opening-fund-guide" className="text-sky-600 underline hover:text-sky-800">開業資金調達ガイド</Link>をご覧ください。
        </Callout>
      </section>
      ...
      <section>
        ...
        <p>具体的にどのKPIを追うべきかは<Link href="/clinic/column/clinic-kpi-dashboard" className="text-sky-600 underline hover:text-sky-800">クリニック経営で見るべきKPI7選</Link>で詳しく解説しています。</p>
      ...
      <section>
        ...
        <Callout type="warning" title="倒産するクリニックに共通する3つの要因">
          <ol className="mt-2 space-y-2 list-decimal pl-4">
            ...
            <li><strong>スタッフの定着率低下</strong> — 採用コストがかさみ、サービス品質も低下する悪循環（<Link href="/clinic/column/clinic-staff-training" className="text-sky-600 underline hover:text-sky-800">スタッフ研修ガイド</Link>で教育・定着策を解説）</li>
            <li><strong>集患力の弱さ</strong> — WebサイトやSNSの活用が不十分で、新患獲得の導線がない（<Link href="/clinic/column/clinic-line-friends-growth" className="text-sky-600 underline hover:text-sky-800">LINE友だち集め月100人増やす7つの施策</Link>も参考にしてください）</li>
          </ol>
        </Callout>
      ...
      <section>
        ...
        <p>上記の失敗要因の多くは、LINEを活用したDX化で大幅に改善できます。具体的な成功事例は<Link href="/clinic/column/medical-dx-success-stories" className="text-sky-600 underline hover:text-sky-800">医療DXの成功事例5選</Link>でも紹介しています。</p>
