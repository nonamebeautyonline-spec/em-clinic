...
const faqItems = [
  { q: "クリニックのオンライン決済導入ガイドの導入にどのくらいの期間がかかりますか？", a: "基本的な設定は1〜2週間で完了します。LINE公式アカウントの開設からリッチメニュー設計・自動メッセージ設定まで、Lオペ for CLINICなら初期設定サポート付きで最短2週間で運用開始できます。" },
  { q: "クリニックのオンライン決済導入ガイドでスタッフの負荷は増えませんか？", a: "むしろ減ります。電話対応・手動での予約管理・問診確認などの定型業務を自動化することで、スタッフの作業時間を月40時間以上削減できた事例もあります。導入初月はサポートを受けながら進めれば、2ヶ月目以降はスムーズに運用できます。" },
  ...
  return (
    <ArticleLayout slug={self.slug} breadcrumbLabel="ガイド" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <p>多くのクリニックでは、会計業務に想像以上の時間とコストがかかっています。オンライン診療の導入費用全般については<Link href="/clinic/column/online-medical-cost" className="text-sky-600 underline hover:text-sky-800">オンライン診療の導入費用と運用コスト</Link>で解説しています。</p>
      ...
      <section>
        ...
        <p>LINEと決済システムを連携することで、患者とクリニック双方にメリットのある決済フローを構築できます。LINE活用による業務自動化の全体像は<Link href="/clinic/column/clinic-line-automation" className="text-sky-600 underline hover:text-sky-800">LINE自動化完全ガイド</Link>でまとめています。</p>
      ...
      <section>
        ...
        <p>オンライン決済の導入により、クリニックの会計業務は大幅に効率化されます。導入効果の計算方法は<Link href="/clinic/column/clinic-line-roi" className="text-sky-600 underline hover:text-sky-800">LINE公式アカウント導入ROI</Link>の記事もご参考ください。</p>
