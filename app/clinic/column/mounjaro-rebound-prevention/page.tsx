  ...
  return (
    <ArticleLayout slug={self.slug} breadcrumbLabel="医薬品解説" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <img src="/clinic/column/images/mounjaro/2010224113693143183-G-XALLybYAABJWm.jpg" alt="マンジャロとリバウンドに関するSNS投稿" className="rounded-xl my-4 w-full" />
      ...
      <section>
        ...
        <p>特に<strong>メトホルミンの併用</strong>は、マンジャロ7.5mg以上を使用していて効果が感じづらくなった場合に有効なケースが多いです。メトホルミンの詳細については<Link href="/clinic/column/glp1-medication-comparison" className="text-sky-600 underline hover:text-sky-800">GLP-1受容体作動薬の比較ガイド</Link>もあわせてご覧ください。</p>
      </section>
      ...
      <section>
        ...
        <p>マンジャロはあくまで<strong>目標体重に到達するための短期集中ツール</strong>。使っている間に食事と運動の習慣を身につけて、自然にやめられる状態を目指しましょう。詳しい使い方については<Link href="/clinic/column/mounjaro-complete-guide" className="text-sky-600 underline hover:text-sky-800">マンジャロ完全ガイド</Link>をご覧ください。</p>
      </section>
