  ...
  return (
    <ArticleLayout slug={self.slug} breadcrumbLabel="電子カルテ" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <p>電子カルテとLINE公式アカウントを連携させることで、<strong>患者とのコミュニケーションとカルテ記録が一つの流れ</strong>でつながります。これにより、従来は手作業だった多くの工程が自動化されます。LINE上でのオンライン診療との組み合わせについては、<Link href="/clinic/column/online-medical-line" className="text-sky-600 underline hover:text-sky-800">オンライン診療×LINEの記事</Link>で詳しく解説しています。</p>
