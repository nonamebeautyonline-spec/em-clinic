    ...
    <ArticleLayout slug={self.slug} breadcrumbLabel="ガイド" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <Callout type="info" title="電子処方箋の今後">
          2023年から運用が開始された電子処方箋が普及すれば、処方箋原本の郵送が不要になります。<Link href="/clinic/column/online-clinic-electronic-prescription" className="text-sky-600 underline hover:text-sky-800">電子処方箋の最新動向と導入ステップ</Link>も併せてご確認ください。ただし、2026年3月時点での対応薬局はまだ限定的であり、全面的な移行には数年を要する見込みです。
        </Callout>
      </section>
      ...
      <section>
        ...
        <p>クリニック側のメリットとしては、薬剤にマージンを乗せられるため<strong>収益性が高い</strong>点が挙げられます。院外処方では処方箋料しか算定できませんが、院内処方では薬剤費にクリニックの利益を含めた価格設定が可能です。具体的な<Link href="/clinic/column/online-clinic-pricing-breakdown" className="text-sky-600 underline hover:text-sky-800">オンライン診療の料金相場と費用設計</Link>についても把握しておくとよいでしょう。</p>
      ...
      <section>
        ...
        <p>2023年の薬機法改正により、オンライン服薬指導の要件が緩和され、初回からオンラインでの服薬指導が可能になりました。<Link href="/clinic/column/online-clinic-medication-counseling" className="text-sky-600 underline hover:text-sky-800">オンライン服薬指導の制度要件と薬局連携の実務</Link>についてはこちらの記事で詳しく解説しています。これにより、保険診療のオンライン診療で「薬局に行く手間」が課題だった点が大きく改善されています。</p>
