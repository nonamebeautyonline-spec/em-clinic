  ...
  return (
    <ArticleLayout slug={self.slug} breadcrumbLabel="医薬品解説" keyPoints={keyPoints} toc={[]}>
      ...
      <section>
        ...
        <p>2020年の規制緩和で、禁煙外来は<strong>初診からオンライン対応が可能</strong>になりました。5回の受診のうち、初回と最終回以外はオンラインで完結できるため、「仕事が忙しくて通えない」という脱落を防げます。オンライン診療の導入手順や法規制については<Link href="/clinic/column/online-clinic-complete-guide" className="text-sky-600 underline hover:text-sky-800">オンライン診療完全ガイド</Link>で詳しく解説しています。</p>
      ...
      <section>
        ...
        <p>クリニックとしては、禁煙外来は<strong>初期投資が少なく、定期受診が組み込まれた収益安定型の診療メニュー</strong>です。LINEでの服薬リマインドと禁煙応援メッセージを組み合わせれば、脱落率の改善と患者満足度の向上を同時に実現できます。禁煙と並行して取り組むべき生活習慣病管理のオンライン化については<Link href="/clinic/column/lifestyle-disease-online-management" className="text-sky-600 underline hover:text-sky-800">生活習慣病オンライン管理ガイド</Link>も参考にしてください。また、オンライン診療での処方ルールについては<Link href="/clinic/column/online-clinic-prescription-rules" className="text-sky-600 underline hover:text-sky-800">オンライン処方ルール解説</Link>をご覧ください。</p>
      </section>
