...
const faqItems = [
  { q: "クリニック開業資金の調達方法で最も重要なポイントは何ですか？", a: "資金計画と集患戦略の両立です。開業資金だけでなく、運転資金（最低6ヶ月分）の確保と、開業前からのLINE公式アカウントやWebサイトによる認知獲得が成功の鍵です。" },
  ...
  return (
    <ArticleLayout slug={slug} breadcrumbLabel="開業・経営" keyPoints={keyPoints} toc={toc}>
      ...
      <p className="text-[15px] leading-relaxed text-gray-700 font-medium bg-blue-50 rounded-xl p-5 border border-blue-100">
        クリニック開業は医師のキャリアにおける最大の投資です。<strong>開業資金は5,000万〜1億円</strong>と言われますが、調達手段は自己資金だけではありません。本記事では、日本政策金融公庫・民間融資・リースなど複数の調達手段を組み合わせて<strong>キャッシュフローを安定させる「ミックス戦略」</strong>を解説します。開業後の運転資金まで見据えた資金計画の立て方を学び、安定した経営基盤を構築しましょう。なお、開業準備全般については<Link href="/clinic/column/minimum-clinic-opening-guide" className="text-sky-600 underline hover:text-sky-800">ミニマム開業ガイド</Link>もあわせてご覧ください。
      </p>
      ...
      <section>
        ...
        <p>
          開業資金の総額は診療科によって大きく異なります。内科や皮膚科のような「設備が比較的軽い」診療科では5,000万〜7,000万円程度で開業可能ですが、眼科や整形外科のように高額な医療機器が必要な診療科では8,000万〜1億円を超えることも珍しくありません。テナント開業と戸建て開業でも差が出ます。個人での自費クリニック開業を検討している方は<Link href="/clinic/column/solo-doctor-self-pay-clinic-opening" className="text-sky-600 underline hover:text-sky-800">個人開業ガイド</Link>も参考にしてください。
        </p>
      ...
      <section>
        ...
        <p>
          このミックス戦略のポイントは、<strong>月々の返済負担を約47万円に分散</strong>している点です。全額を民間融資で調達した場合の月返済額（約55万円）と比較して、月8万円・年間96万円のコスト差が生まれます。また、自己資金を全額投入せず手元に残すことで、開業後の不測の事態にも対応できます。開業後の<Link href="/clinic/column/clinic-fixed-cost-optimization" className="text-sky-600 underline hover:text-sky-800">固定費最適化</Link>も組み合わせれば、キャッシュフローの安定度はさらに高まります。資金計画は必ず税理士や金融の専門家と相談しながら策定してください。
        </p>
      ...
      <section>
        ...
        <p>
          クリニック開業は人生最大の投資であり、資金調達の巧拙がその後の経営安定を大きく左右します。「いくら借りられるか」ではなく、<strong>「いくらなら安全に返済できるか」</strong>から逆算して資金計画を立てることが、持続可能なクリニック経営の第一歩です。返済計画の妥当性を検証するには、<Link href="/clinic/column/self-pay-clinic-break-even" className="text-sky-600 underline hover:text-sky-800">損益分岐点の考え方</Link>を押さえておくことが不可欠です。開業後のランニングコストを抑えるDX戦略については、Lオペ for CLINICのような統合プラットフォームの活用も検討してみてください。
        </p>
        ...
        <ul className="space-y-1 text-gray-700">
          <li>
            <Link href="/clinic/column/minimum-clinic-opening-guide" className="text-sky-600 underline hover:text-sky-800">ミニマム開業ガイド</Link> — 最小コストで開業する方法
          </li>
          <li>
            <Link href="/clinic/column/one-room-clinic-simulation" className="text-sky-600 underline hover:text-sky-800">ワンルーム開業シミュレーション</Link> — 省スペース開業の収支モデル
          </li>
          <li>
            <Link href="/clinic/column/self-pay-clinic-break-even" className="text-sky-600 underline hover:text-sky-800">自費クリニックの損益分岐点</Link> — 収支管理の基本
          </li>
          <li>
            <Link href="/clinic/column/clinic-fixed-cost-optimization" className="text-sky-600 underline hover:text-sky-800">固定費最適化ガイド</Link> — 開業後のコスト管理
          </li>
          <li>
            <Link href="/clinic/contact" className="text-sky-600 underline hover:text-sky-800">無料相談・お問い合わせ</Link> — 開業準備のご相談はこちら
          </li>
        </ul>
      </section>
