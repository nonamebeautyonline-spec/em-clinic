        ...
        <header className="sticky top-0 z-30 border-b border-gray-200/60 bg-white/95 backdrop-blur-md">
          <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-3.5">
            ...
            <div className="flex items-center gap-6">
              <Link href="/clinic/about" className="hidden text-[14px] text-gray-500 hover:text-blue-600 transition md:block">
                Lオペとは
              </Link>
              <Link href="/clinic/features" className="hidden text-[14px] text-gray-500 hover:text-blue-600 transition md:block">
                機能一覧
              </Link>
              <Link href="/clinic/column" className="hidden text-[14px] font-medium text-blue-600 md:block">
                コラム
              </Link>
              <a
                href="/#contact"
        ...
        <div className="border-b border-gray-200 bg-white">
          <nav aria-label="パンくずリスト" className="mx-auto max-w-7xl px-6 py-3">
            <ol className="flex items-center gap-2 text-[13px] text-gray-400 list-none m-0 p-0">
              ...
              <li>
                <Link href="/clinic/column" className="hover:text-blue-600 transition">
                  コラム
                </Link>
              </li>
              <li aria-hidden="true" className="text-gray-300">
          ...
          <div className="mx-auto max-w-7xl px-6">
            <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-between">
              ...
              <div className="flex items-center gap-6">
                ...
                <Link href="/clinic/about" className="text-[13px] text-gray-400 hover:text-blue-600 transition">
                  Lオペとは
                </Link>
                <Link href="/clinic/features" className="text-[13px] text-gray-400 hover:text-blue-600 transition">
                  機能一覧
                </Link>
                <Link href="/clinic/column" className="text-[13px] text-blue-600 font-medium">
                  コラム
                </Link>
              </div>
            </div>
