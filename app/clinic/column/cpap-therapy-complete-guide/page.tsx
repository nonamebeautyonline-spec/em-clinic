    ...
    <ArticleLayout slug={self.slug} breadcrumbLabel="CPAP療法完全ガイド" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <p className="text-sm text-gray-500 mt-4">
          関連記事: <Link href="/clinic/column/insomnia-online-clinic-lope" className="text-blue-600 hover:underline">不眠症・睡眠薬のオンライン処方ガイド</Link>
        </p>
      </section>
      ...
      <section>
        ...
        <p className="text-sm text-gray-500 mt-6">
          関連記事:
          <Link href="/clinic/column/insomnia-online-clinic-lope" className="text-blue-600 hover:underline ml-2">不眠症・睡眠薬のオンライン処方ガイド</Link>
          <span className="mx-1">|</span>
          <Link href="/clinic/column/online-clinic-complete-guide" className="text-blue-600 hover:underline">オンライン診療完全ガイド</Link>
        </p>
      </section>
    </ArticleLayout>
  );
