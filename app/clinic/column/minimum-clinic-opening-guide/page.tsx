...
const faqItems = [
  { q: "ミニマム開業完全ガイドで最も重要なポイントは何ですか？", a: "資金計画と集患戦略の両立です。開業資金だけでなく、運転資金（最低6ヶ月分）の確保と、開業前からのLINE公式アカウントやWebサイトによる認知獲得が成功の鍵です。" },
    ...
    <ArticleLayout slug={self.slug} breadcrumbLabel="ミニマム開業完全ガイド" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <Callout type="info" title="損益分岐点は月商25〜35万円">
          ...
          コスト最適化の詳細は<Link href="/clinic/column/clinic-fixed-cost-optimization" className="text-sky-600 underline hover:text-sky-800">クリニック固定費最適化ガイド</Link>もご参照ください。
        </Callout>
      </section>
      ...
      <section>
        ...
        <Callout type="point" title="最短1ヶ月で診療開始可能">
          ...
          開業準備の全体像は<Link href="/clinic/column/clinic-opening-line" className="text-sky-600 underline hover:text-sky-800">クリニック開業×LINE活用ガイド</Link>も参考になります。
        </Callout>
      ...
      <section>
        ...
        <Callout type="info" title="クロスセルがLTV最大化の鍵">
          ...
          LTV最大化の詳細は<Link href="/clinic/column/self-pay-patient-ltv-maximize" className="text-sky-600 underline hover:text-sky-800">自費診療LTV最大化ガイド</Link>もご参照ください。
        </Callout>
      </section>
      ...
      <section>
        ...
        <Callout type="point" title="AI自動返信で問い合わせ対応を90%自動化">
          ...
          AI返信の活用法は<Link href="/clinic/column/ai-auto-reply-guide" className="text-sky-600 underline hover:text-sky-800">AI自動返信ガイド</Link>で詳しく解説しています。
        </Callout>

        <p>DX活用の具体的なビフォーアフターについては<Link href="/clinic/column/clinic-dx-before-after" className="text-sky-600 underline hover:text-sky-800">クリニックDXビフォーアフター</Link>もご参照ください。クリニック全体のDX戦略については<Link href="/clinic/column/clinic-dx-complete-guide" className="text-sky-600 underline hover:text-sky-800">クリニックDX完全ガイド</Link>が包括的な参考になります。</p>
      </section>
      ...
      <section>
        ...
        <p>Lオペの全機能と導入事例については<Link href="/clinic/column/lope-complete-introduction" className="text-sky-600 underline hover:text-sky-800">Lオペ完全導入ガイド</Link>をご確認ください。自費診療の売上最大化については<Link href="/clinic/column/self-pay-clinic-revenue-triple" className="text-sky-600 underline hover:text-sky-800">自費診療売上3倍化ガイド</Link>も合わせてご覧ください。</p>
      </section>
      ...
      <section>
        ...
        <p>ミニマム開業を検討されている方は、まずは<Link href="/clinic/contact" className="text-sky-600 underline hover:text-sky-800">無料相談</Link>でLオペの導入プランをご相談ください。診療メニューの選定からLINE公式アカウントの設計、集患戦略まで、専任スタッフがトータルでサポートします。</p>

        <p className="mt-4 text-[13px] text-gray-500">関連コラム: <Link href="/clinic/column/online-clinic-complete-guide" className="text-sky-600 underline hover:text-sky-800">オンライン診療完全ガイド</Link> / <Link href="/clinic/column/online-medical-cost" className="text-sky-600 underline hover:text-sky-800">オンライン診療のコスト完全解説</Link> / <Link href="/clinic/column/clinic-cost-reduction-30man" className="text-sky-600 underline hover:text-sky-800">クリニックコスト削減30万円</Link> / <Link href="/clinic/column/clinic-self-pay-revenue" className="text-sky-600 underline hover:text-sky-800">自費診療の収益化</Link> / <Link href="/clinic/column/lope-complete-introduction" className="text-sky-600 underline hover:text-sky-800">Lオペ完全ガイド</Link></p>
      </section>
