    ...
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(jsonLd) }} />
        ...
        <section>
          ...
          <p>この「目に見えないコスト」を意識している経営者は多くありません。しかし、この時間をどう活用するかが、クリニックの成長を左右する分岐点になります。業務効率化の全体像については<Link href="/clinic/column/clinic-dx-daily-transformation" className="text-sky-600 underline hover:text-sky-800">クリニックDXで日常業務がどう変わるか</Link>で詳しく解説しています。</p>
        </section>
        ...
        <section>
          ...
          <p>友だち追加を月100人増やす具体的な施策は<Link href="/clinic/column/clinic-line-friends-growth" className="text-sky-600 underline hover:text-sky-800">クリニックのLINE友だち集め — 月100人増やす7つの施策</Link>で解説しています。</p>
          ...
          <p>紹介制度の具体的な設計方法は<Link href="/clinic/column/clinic-referral-program" className="text-sky-600 underline hover:text-sky-800">クリニックの紹介制度をLINEで仕組み化する方法</Link>をご覧ください。</p>
        ...
        <section>
          ...
          <p>LINE活用による売上アップの全体戦略については<Link href="/clinic/column/clinic-line-revenue-growth" className="text-sky-600 underline hover:text-sky-800">クリニックの売上を上げるLINE活用術</Link>で詳しく解説しています。</p>
        </section>
        ...
        <section>
          ...
          <p>コスト削減の具体的な内訳と計算方法については<Link href="/clinic/column/clinic-cost-reduction-30man" className="text-sky-600 underline hover:text-sky-800">クリニックDXで月30万円のコスト削減を実現する方法</Link>で詳しく解説しています。</p>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc pl-6 space-y-1">
            <li><Link href="/clinic/column/clinic-line-revenue-growth" className="text-sky-600 underline hover:text-sky-800">クリニックの売上を上げるLINE活用術</Link></li>
            <li><Link href="/clinic/column/clinic-line-friends-growth" className="text-sky-600 underline hover:text-sky-800">クリニックのLINE友だち集め — 月100人増やす7つの施策</Link></li>
            <li><Link href="/clinic/column/clinic-dx-daily-transformation" className="text-sky-600 underline hover:text-sky-800">クリニックDXで日常業務がどう変わるか</Link></li>
            <li><Link href="/clinic/column/clinic-cost-reduction-30man" className="text-sky-600 underline hover:text-sky-800">クリニックDXで月30万円のコスト削減を実現する方法</Link></li>
            <li><Link href="/clinic/column/clinic-referral-program" className="text-sky-600 underline hover:text-sky-800">クリニックの紹介制度をLINEで仕組み化する方法</Link></li>
          </ul>
        </section>
