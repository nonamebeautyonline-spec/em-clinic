  ...
  return (
    <ArticleLayout slug={self.slug} breadcrumbLabel="活用事例" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <p>
          SAS未治療による経済損失は交通事故・労働災害・生産性低下を合わせて<strong>年間約3,400億円</strong>と推計されています。企業の健康経営への関心の高まりもあり、<strong>企業健診でのSASスクリーニング</strong>は年々拡大しています。この流れは、オンラインクリニックにとって追い風です。オンライン診療の全体像は<Link href="/clinic/column/online-clinic-complete-guide" className="text-sky-600 underline hover:text-sky-800">オンライン診療完全ガイド</Link>で詳しく解説しています。
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          患者1人あたりのLTV（生涯価値）を試算すると、保険診療で月額13,500円 x 36〜60か月で<strong>48.6〜81万円</strong>、自費でも月額10,000円 x 36〜60か月で<strong>36〜60万円</strong>に達します。フロー型の単発診療（風邪・胃腸炎など）と比較すると、LTVの差は歴然です。CPAP管理100人を獲得すれば、保険で<strong>月135万円</strong>、自費でも<strong>月100万円前後の安定収益</strong>がDr1人の最小人員で実現できます。収益の詳細は<Link href="/clinic/column/self-pay-clinic-revenue-triple" className="text-sky-600 underline hover:text-sky-800">自費クリニック収益3倍化ガイド</Link>も参考にしてください。
        </p>
      </section>
      ...
      <section>
        ...
        <Callout type="warning" title="保険CPAP管理のオンライン診療ルール">
          保険診療でのCPAP管理においては、<strong>一定の対面診療の組み合わせ</strong>が求められる場合があります。2024年の診療報酬改定で遠隔モニタリング加算が新設されるなど制度は進んでいますが、完全オンライン化の可否は地域の厚生局の解釈によって異なります。自費診療であればこの制約はありません。制度面の詳細は<Link href="/clinic/column/online-clinic-regulations" className="text-sky-600 underline hover:text-sky-800">オンライン診療の制度と規制ガイド</Link>を確認してください。
        </Callout>
      </section>
      ...
      <section>
        ...
        <p>
          <strong>4. LINE友だち追加からの自動ナーチャリング</strong>: 「いびきセルフチェック」などの無料コンテンツをLINEで提供し、友だち追加を獲得。<Link href="/clinic/column/segment-delivery-repeat" className="text-sky-600 underline hover:text-sky-800">セグメント配信</Link>でSASの啓発情報を段階的に配信し、<strong>検査への動機づけを自動化</strong>します。
        </p>
      ...
      <section>
        ...
        <p>
          固定費の合計は<strong>月22〜31万円程度</strong>（Dr報酬除く）。対面クリニックの開業に必要な数千万円の設備投資と比較すると、<strong>圧倒的に低い初期投資・固定費</strong>で開業できることがSASオンラインクリニックの大きな利点です。開業コストの詳細は<Link href="/clinic/column/minimum-clinic-opening-guide" className="text-sky-600 underline hover:text-sky-800">最小開業ガイド</Link>も参考にしてください。
        </p>
      ...
      <section>
        ...
        <ul className="space-y-1 text-gray-700">
          ...
          <li>
            <Link href="/clinic/column/insomnia-online-clinic-lope" className="text-sky-600 underline hover:text-sky-800">不眠症オンライン処方ガイド</Link> — 同じ睡眠領域の不眠症診療との相乗効果
          </li>
          <li>
            <Link href="/clinic/column/minimum-clinic-opening-guide" className="text-sky-600 underline hover:text-sky-800">最小開業ガイド</Link> — 初期投資を最小限に抑えるクリニック開業戦略
          </li>
          <li>
            <Link href="/clinic/column/clinic-repeat-rate-improvement" className="text-sky-600 underline hover:text-sky-800">リピート率改善ガイド</Link> — 定期フォローで患者の継続率を向上させる手法
          </li>
          <li>
            <Link href="/clinic/contact" className="text-sky-600 underline hover:text-sky-800">無料相談・お問い合わせ</Link> — SASオンラインクリニックの運用設計をご相談いただけます
          </li>
        </ul>
      </section>
