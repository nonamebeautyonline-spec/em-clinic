  ...
  return (
    <ArticleLayout slug={self.slug} breadcrumbLabel="医薬品解説" keyPoints={keyPoints} toc={[]}>
      ...
      <section>
        ...
        <ul className="space-y-1 text-gray-700">
          <li>
            <Link href="/clinic/column/glp1-medication-guide" className="text-sky-600 underline hover:text-sky-800">GLP-1受容体作動薬ガイド</Link> — リベルサス・オゼンピック・マンジャロの基礎知識
          </li>
          <li>
            <Link href="/clinic/column/glp1-diet-safety-evidence" className="text-sky-600 underline hover:text-sky-800">GLP-1ダイエットの安全性エビデンス</Link> — 副作用リスクと安全管理の要点
          </li>
          <li>
            <Link href="/clinic/column/rybelsus-side-effects-guide" className="text-sky-600 underline hover:text-sky-800">リベルサスの副作用と対処法</Link> — 吐き気・下痢への具体的な対応策
          </li>
        </ul>
      </section>
