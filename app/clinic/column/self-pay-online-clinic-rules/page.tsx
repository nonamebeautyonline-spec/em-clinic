  ...
  return (
    <ArticleLayout slug={self.slug} breadcrumbLabel="ガイド" keyPoints={keyPoints} toc={toc}>
      ...
      <p className="text-[15px] leading-relaxed text-gray-700 font-medium bg-blue-50 rounded-xl p-5 border border-blue-100">
        自費診療でオンライン診療を始める際、保険診療とは異なるルール・規制が多数存在します。厚労省の指針に加え、<strong>薬機法・医療広告ガイドライン・特定商取引法・個人情報保護法</strong>など、関連する法規制は多岐にわたります。本記事では2026年3月時点の最新情報に基づき、自費クリニックが遵守すべきルールの要点を網羅的に整理します。オンライン診療の法規制全般については<Link href="/clinic/column/online-clinic-regulations" className="text-sky-600 underline hover:text-sky-800">オンライン診療の法規制と薬機法ガイド</Link>、広告規制の詳細は<Link href="/clinic/column/clinic-ad-yakki-ho-guide" className="text-sky-600 underline hover:text-sky-800">クリニック広告の薬機法ガイド</Link>もあわせてご覧ください。
      </p>
      ...
      <section>
        ...
        <p>
          保険診療では<strong>療養担当規則</strong>に基づく制約がありますが、自費診療ではその制約がありません。一方で、自費診療には<strong>消費者保護の観点からの規制</strong>が追加で適用されます。特に定期購入型のサブスクリプションモデルを採用する場合、特定商取引法への対応が必要です。サブスクモデルの具体的な設計方法は<Link href="/clinic/column/self-pay-clinic-subscription-model" className="text-sky-600 underline hover:text-sky-800">サブスクリプションモデル導入ガイド</Link>で解説しています。また、広告においては保険診療よりも自費診療のほうが厳しく監視される傾向にあり、医療広告ガイドラインの詳細は<Link href="/clinic/column/clinic-ad-yakki-ho-guide" className="text-sky-600 underline hover:text-sky-800">広告と薬機法ガイド</Link>をご確認ください。
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          自費クリニックでよく処方される薬剤としては、AGA治療薬（フィナステリド、デュタステリド、ミノキシジル）、ED治療薬（シルデナフィル、タダラフィル）、低用量ピル、GLP-1受容体作動薬（リベルサス等）、美容内服薬（トラネキサム酸、シナール等）があります。これらの多くは国内承認薬ですが、<strong>広告における表現には薬機法の規制が適用</strong>されるため、Webサイトやチラシでの記載内容には十分な注意が必要です。薬剤別の詳細は<Link href="/clinic/column/aga-online-clinic-lope" className="text-sky-600 underline hover:text-sky-800">AGAオンライン診療ガイド</Link>や<Link href="/clinic/column/pill-online-clinic-lope" className="text-sky-600 underline hover:text-sky-800">ピルオンライン処方ガイド</Link>もご参照ください。
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          オンライン診療では、診察料・システム利用料・処方料・薬剤費・送料など、<strong>複数の費目が発生</strong>するため、患者にとって総額が分かりにくくなりがちです。すべての費目を明示し、患者が事前に合計費用を把握できるようにすることが重要です。自費診療の料金設計の詳細は<Link href="/clinic/column/self-pay-pricing-guide" className="text-sky-600 underline hover:text-sky-800">自費診療の価格設定ガイド</Link>もご参照ください。
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          Lオペでは、患者データの暗号化保存やアクセスログの記録に対応しています。セキュリティ対策の詳細については<Link href="/clinic/column/clinic-line-security" className="text-sky-600 underline hover:text-sky-800">クリニックLINEセキュリティガイド</Link>をご参照ください。
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          法規制を正しく理解し遵守することは、クリニックを法的リスクから守るだけでなく、患者からの信頼を築く基盤となります。自費オンライン診療のコンプライアンス体制を整え、安全で持続的なクリニック経営を実現しましょう。関連記事として、開業準備の全体像は<Link href="/clinic/column/online-clinic-complete-guide" className="text-sky-600 underline hover:text-sky-800">オンライン診療完全ガイド</Link>、法人設立から届出までの手続きは<Link href="/clinic/column/online-clinic-legal-setup-guide" className="text-sky-600 underline hover:text-sky-800">オンライン診療の開業法務ガイド</Link>、収益モデルの詳細は<Link href="/clinic/column/self-pay-clinic-revenue-triple" className="text-sky-600 underline hover:text-sky-800">自費クリニック売上3倍戦略</Link>もあわせてご覧ください。お問い合わせは<Link href="/clinic/contact" className="text-sky-600 underline hover:text-sky-800">こちら</Link>から。
        </p>
      </section>
