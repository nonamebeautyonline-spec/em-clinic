...
const faqItems = [
  { q: "クリニックDX導入ビフォーアフターの導入にどのくらいの期間がかかりますか？", a: "基本的な設定は1〜2週間で完了します。LINE公式アカウントの開設からリッチメニュー設計・自動メッセージ設定まで、Lオペ for CLINICなら初期設定サポート付きで最短2週間で運用開始できます。" },
  { q: "クリニックDX導入ビフォーアフターでスタッフの負荷は増えませんか？", a: "むしろ減ります。電話対応・手動での予約管理・問診確認などの定型業務を自動化することで、スタッフの作業時間を月40時間以上削減できた事例もあります。導入初月はサポートを受けながら進めれば、2ヶ月目以降はスムーズに運用できます。" },
...
export default function Page() {
  return (
    <ArticleLayout slug={self.slug} breadcrumbLabel="活用事例" keyPoints={keyPoints} toc={toc}>
      ...
      <p>
        そこで本記事では、規模も診療科も異なる3つのクリニックで実際に起きた変化を、導入前・導入後の比較で詳しく解説します。LINE活用の事例全体を知りたい方は<Link href="/clinic/column/clinic-line-case-studies" className="text-emerald-700 underline">クリニックのLINE公式アカウント活用事例5選</Link>もあわせてご覧ください。
      </p>
      ...
      <section>
        ...
        <p>
          都内で開業5年目の美容皮膚科クリニック。院長1名、看護師3名、受付2名、カウンセラー1名の体制です。自費診療中心ながらも、新規患者の獲得とリピート率に課題を抱えていました。固定費削減の具体的な数値については<Link href="/clinic/column/clinic-cost-reduction-30man" className="text-sky-600 underline hover:text-sky-800">固定費を月30万円削減する方法</Link>でも紹介しています。
        </p>
        ...
        <p>
          売上アップの詳細なメカニズムについては<Link href="/clinic/column/clinic-line-revenue-growth" className="text-emerald-700 underline">LINE活用でクリニック売上を伸ばす方法</Link>で体系的に解説しています。
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          クリニック日常業務のDX変革について詳しく知りたい方は<Link href="/clinic/column/clinic-dx-daily-transformation" className="text-emerald-700 underline">クリニックDXで日常業務はこう変わる</Link>もご覧ください。
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          DX導入のステップについてより詳しく知りたい方は<Link href="/clinic/column/lope-complete-introduction" className="text-emerald-700 underline">Lオペ完全導入ガイド</Link>をご覧ください。全機能を活用した包括的な導入方法を解説しています。
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          本記事で紹介した3院のように、まずは最もインパクトの大きい1つの業務からスタートし、段階的に範囲を広げていくアプローチが成功の鍵です。DX導入の全体設計図は<Link href="/clinic/column/clinic-dx-complete-guide" className="text-sky-600 underline hover:text-sky-800">クリニックDX完全ガイド</Link>でも体系的にまとめています。Lオペでは導入前の業務診断から運用定着までを一貫してサポートしています。
        </p>
        ...
        <ul className="space-y-2 text-[14px]">
          <li>
            <Link href="/clinic/column/clinic-line-case-studies" className="text-emerald-700 underline hover:text-emerald-900">クリニックのLINE公式アカウント活用事例5選</Link> — LINE活用の事例を幅広く紹介
          </li>
          <li>
            <Link href="/clinic/column/clinic-line-revenue-growth" className="text-emerald-700 underline hover:text-emerald-900">LINE活用でクリニック売上を伸ばす方法</Link> — 売上アップのメカニズムを体系的に解説
          </li>
          <li>
            <Link href="/clinic/column/clinic-dx-daily-transformation" className="text-emerald-700 underline hover:text-emerald-900">クリニックDXで日常業務はこう変わる</Link> — 日々の業務がどう変化するかを具体的に紹介
          </li>
          <li>
            <Link href="/clinic/column/lope-complete-introduction" className="text-emerald-700 underline hover:text-emerald-900">Lオペ完全導入ガイド</Link> — 導入から運用定着までのステップを網羅
          </li>
          <li>
            <Link href="/clinic/contact" className="text-sky-600 underline hover:text-sky-800">無料相談・資料請求</Link> — まずはお気軽にご相談ください
          </li>
        </ul>
      </section>
