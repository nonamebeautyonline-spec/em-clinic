...
const faqItems = [
  { q: "マンジャロとピル・月経はオンライン診療で処方できますか？", a: "多くの場合、オンライン診療での処方が可能です。ただし初診では処方日数に制限がある場合があります。再診であれば対面診療と同等の処方が可能です。詳しくは各薬剤の処方ルールをご確認ください。" },
  ...
  return (
    <ArticleLayout slug={self.slug} breadcrumbLabel="医薬品解説" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <p>「マンジャロで目標体重まで落としてから妊活したい」という方は、<strong>最終投与→1ヶ月以上待機→妊活開始</strong>というスケジュールを立てましょう。この待機期間中の体重維持については<Link href="/clinic/column/mounjaro-complete-guide" className="text-sky-600 underline hover:text-sky-800">マンジャロ完全ガイド</Link>も参考にしてください。</p>
      </section>
      ...
      <section>
        ...
        <p>ピルの種類や選び方については<Link href="/clinic/column/low-dose-pill-beginners-guide" className="text-sky-600 underline hover:text-sky-800">低用量ピル初心者ガイド</Link>や<Link href="/clinic/column/pill-types-comparison" className="text-sky-600 underline hover:text-sky-800">ピルの種類比較</Link>もあわせてどうぞ。</p>
      </section>
      ...
      <section>
        ...
        <p>女性がマンジャロを使う際は、婦人科の担当医にもマンジャロの使用を伝えて、ピルや他のホルモン剤との兼ね合いを確認してもらいましょう。総合的な使い方については<Link href="/clinic/column/mounjaro-complete-guide" className="text-sky-600 underline hover:text-sky-800">マンジャロ完全ガイド</Link>をご参照ください。</p>
      </section>
