...
const faqItems = [
  { q: "クリニックのAI返信活用ガイドの導入にどのくらいの期間がかかりますか？", a: "基本的な設定は1〜2週間で完了します。LINE公式アカウントの開設からリッチメニュー設計・自動メッセージ設定まで、Lオペ for CLINICなら初期設定サポート付きで最短2週間で運用開始できます。" },
  { q: "クリニックのAI返信活用ガイドでスタッフの負荷は増えませんか？", a: "むしろ減ります。電話対応・手動での予約管理・問診確認などの定型業務を自動化することで、スタッフの作業時間を月40時間以上削減できた事例もあります。導入初月はサポートを受けながら進めれば、2ヶ月目以降はスムーズに運用できます。" },
  ...
  return (
    <ArticleLayout slug={self.slug} breadcrumbLabel="ガイド" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <p><Link href="/clinic/column/ai-auto-reply-guide" className="text-sky-600 underline hover:text-sky-800">AI自動返信導入ガイド</Link>では、AI返信の基本的な導入メリットと概要を解説しています。本記事ではより実践的な活用方法に踏み込みます。</p>
      </section>
      ...
      <section>
        ...
        <p>AI返信を効果的に運用するための日常フローを紹介します。<Link href="/clinic/column/clinic-line-automation" className="text-sky-600 underline hover:text-sky-800">LINE自動化完全ガイド</Link>のAI返信セクションと合わせて参考にしてください。</p>
        ...
        <p><Link href="/clinic/column/clinic-patient-communication" className="text-sky-600 underline hover:text-sky-800">患者コミュニケーション改善のポイント</Link>で解説している双方向性と一貫性の原則は、AI返信の運用にもそのまま適用できます。</p>
      </section>
