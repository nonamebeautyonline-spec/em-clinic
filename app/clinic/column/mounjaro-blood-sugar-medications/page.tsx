  ...
  return (
    <ArticleLayout slug={self.slug} breadcrumbLabel="医薬品解説" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <img src="/clinic/column/images/mounjaro/1966714297431802236-G0ssOd9bkAAtvC1.jpg" alt="インスリン分泌に関する誤解の解説" className="rounded-xl my-4 w-full" />
      ...
      <section>
        ...
        <img src="/clinic/column/images/mounjaro/1916363996934164908-GphK5WMbEAMqAEM.png" alt="メトホルミンとマンジャロの併用解説" className="rounded-xl my-4 w-full" />
        ...
        <Callout type="warning" title="メトホルミンの個人輸入は危険">
          海外の個人輸入サイトでメトホルミンを購入する人がいますが、<strong>品質管理が不明な薬剤の使用は非常に危険</strong>です。偽薬や不純物混入のリスクがあり、重篤な副作用（乳酸アシドーシス等）を起こす可能性もあります。必ず医師の処方を受けてください。詳しくは<Link href="/clinic/column/metformin-personal-import-risk" className="text-sky-600 underline hover:text-sky-800">メトホルミン個人輸入のリスク</Link>をご覧ください。
        </Callout>
      </section>
      ...
      <section>
        ...
        <img src="/clinic/column/images/mounjaro/1966714297431802236-G0ssOeDbcAIeC9V.jpg" alt="マンジャロと精神科薬の併用に関する解説" className="rounded-xl my-4 w-full" />
      ...
      <section>
        ...
        <p>併用薬がある方は、マンジャロを始める前に必ず担当医に全ての服用中の薬を伝えてください。副作用や相互作用の詳細については<Link href="/clinic/column/mounjaro-side-effects-guide" className="text-sky-600 underline hover:text-sky-800">マンジャロの副作用ガイド</Link>も参考にどうぞ。</p>
      </section>
      ...
      <section>
        ...
        <p>マンジャロは多くの薬と安全に併用できますが、「自己判断での併用」は危険です。必ず担当医に相談してから使い始めましょう。マンジャロ全般の使い方については<Link href="/clinic/column/mounjaro-complete-guide" className="text-sky-600 underline hover:text-sky-800">マンジャロ完全ガイド</Link>、GLP-1薬の全体像は<Link href="/clinic/column/glp1-diet-safety-evidence" className="text-sky-600 underline hover:text-sky-800">GLP-1ダイエットのエビデンス</Link>をご覧ください。</p>
      </section>
