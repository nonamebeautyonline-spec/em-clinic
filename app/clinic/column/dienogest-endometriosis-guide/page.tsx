  ...
  return (
    <ArticleLayout slug={self.slug} breadcrumbLabel="医薬品解説" keyPoints={keyPoints} toc={[]}>
      ...
      <section>
        ...
        <p>ここが大きな分岐点です。<strong>ジエノゲストにはエストロゲンが入っていません</strong>。つまり、血栓リスクが高くてピルが使えない方、35歳以上のヘビースモーカー、片頭痛（前兆あり）の方など、エストロゲン含有製剤が禁忌の患者さんにも処方できるのです。ピルの種類と選び方については<Link href="/clinic/column/pill-types-comparison" className="text-sky-600 underline hover:text-sky-800">ピル種類比較ガイド</Link>で詳しく解説しています。</p>
      ...
      <section>
        ...
        <p>もちろん、不正出血という「避けて通れない副作用」はあります。しかし、事前の丁寧な説明と最初の3ヶ月を乗り越えるサポートがあれば、多くの患者さんが長期的な疼痛管理を実現できます。<strong>「正しい情報提供」と「継続的なフォロー」</strong>——この2つが揃ったとき、ジエノゲストは子宮内膜症治療の強力な武器になるのです。婦人科領域のオンライン診療については<Link href="/clinic/column/gynecology-online-clinic-guide" className="text-sky-600 underline hover:text-sky-800">婦人科オンライン診療ガイド</Link>も参考にしてください。PMSへの処方アプローチについては<Link href="/clinic/column/pms-online-prescription-guide" className="text-sky-600 underline hover:text-sky-800">PMSオンライン処方ガイド</Link>もあわせてご覧ください。</p>
      </section>
