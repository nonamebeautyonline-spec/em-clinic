    ...
    <ArticleLayout slug={self.slug} breadcrumbLabel="LINE運用ガイド" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <Callout type="success" title="リッチメニュー設計の詳細はこちら">
          患者導線を最適化する5つのポイントは<Link href="/clinic/column/rich-menu-design" className="text-emerald-700 underline">クリニックのLINEリッチメニュー設計ガイド</Link>で詳しく解説しています。
        </Callout>
      </section>
      ...
      <section>
        ...
        <Callout type="point" title="運用代行と自社運用の詳細比較はこちら">
          規模別の最適な判断基準は<Link href="/clinic/column/line-operation-outsource-vs-inhouse" className="text-emerald-700 underline">LINE運用代行 vs 自社運用 -- どちらが正解？</Link>で詳しく解説しています。
        </Callout>
      </section>
