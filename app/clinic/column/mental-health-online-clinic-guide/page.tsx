  ...
  return (
    <ArticleLayout slug={self.slug} breadcrumbLabel="ガイド" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <p>
          管理患者80人の場合、<strong>月間約47万円の収益</strong>が見込めます。メンタルヘルス疾患は治療が長期にわたるため患者の積み上げが容易であり、150人で月間80万円超、200人で月間100万円超の安定収益となります。不眠症は特にオンライン診療との親和性が高く、<strong>「不眠症オンライン外来」として特化することで効率的な集患</strong>が可能です。不眠症外来の具体的な差別化戦略については<Link href="/clinic/column/insomnia-online-winning-strategy" className="text-sky-600 underline hover:text-sky-800">不眠症オンライン外来の勝ち筋</Link>も参考にしてください。
        </p>
      </section>
      ...
      <section>
        ...
        <ul className="space-y-1 text-gray-700">
          <li>
            <Link href="/clinic/column/insomnia-online-clinic-lope" className="text-sky-600 underline hover:text-sky-800">不眠症のオンライン処方ガイド</Link> — 不眠症に特化したオンライン診療の詳細
          </li>
          <li>
            <Link href="/clinic/column/online-clinic-prescription-rules" className="text-sky-600 underline hover:text-sky-800">オンライン診療の処方ルール</Link> — 向精神薬を含む処方制限の最新情報
          </li>
          <li>
          ...
          <li>
            <Link href="/clinic/column/online-clinic-regulations" className="text-sky-600 underline hover:text-sky-800">オンライン診療の制度と規制ガイド</Link> — 診療報酬・法的要件の整理
          </li>
          <li>
            <Link href="/clinic/column/clinic-repeat-rate-improvement" className="text-sky-600 underline hover:text-sky-800">リピート率改善ガイド</Link> — 継続治療の患者を離脱させないノウハウ
          </li>
          <li>
            <Link href="/clinic/contact" className="text-sky-600 underline hover:text-sky-800">無料相談・お問い合わせ</Link> — メンタルヘルスオンライン外来の運用設計をご相談いただけます
          </li>
        </ul>
      </section>
