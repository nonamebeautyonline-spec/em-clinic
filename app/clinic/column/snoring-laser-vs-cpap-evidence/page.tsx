    ...
    <ArticleLayout slug={self.slug} breadcrumbLabel="エビデンス解説" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <ul className="space-y-1 text-gray-700">
          <li>
            <Link href="/clinic/column/sas-snoring-online-clinic-guide" className="text-sky-600 underline hover:text-sky-800">いびき・SASオンライン診療ガイド</Link> — SASのオンライン診療の始め方から運用まで
          </li>
          <li>
            <Link href="/clinic/column/cpap-therapy-complete-guide" className="text-sky-600 underline hover:text-sky-800">CPAP療法完全ガイド</Link> — CPAPの導入・フォロー・アドヒアランス管理の全体像
          </li>
          <li>
            <Link href="/clinic/column/sas-cpap-online-winning-strategy" className="text-sky-600 underline hover:text-sky-800">SAS・CPAPオンライン診療の勝ちパターン</Link> — CPAP管理料のオンライン化と収益モデル
          </li>
          <li>
            <Link href="/clinic/column/online-clinic-complete-guide" className="text-sky-600 underline hover:text-sky-800">オンライン診療完全ガイド</Link> — オンライン診療の制度・始め方を網羅的に解説
          </li>
          <li>
            <Link href="/clinic/contact" className="text-sky-600 underline hover:text-sky-800">無料相談・お問い合わせ</Link> — SASオンライン診療の運用設計をご相談いただけます
          </li>
        </ul>
      </section>
