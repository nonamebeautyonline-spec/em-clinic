  ...
  return (
    <ArticleLayout slug={self.slug} breadcrumbLabel="マーケティング" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <p>患者LTVの考え方と向上戦略の全体像は<Link href="/clinic/column/clinic-patient-ltv" className="text-sky-600 underline hover:text-sky-800">患者LTV向上戦略</Link>で詳しく解説しています。患者離脱を防ぐフォローアップの設計は<Link href="/clinic/column/clinic-patient-retention" className="text-sky-600 underline hover:text-sky-800">患者離脱防止ガイド</Link>もあわせてご覧ください。</p>
      </section>
      ...
      <section>
        ...
        <p>LINE友だちを効率的に増やす施策全般については<Link href="/clinic/column/clinic-line-friends-growth" className="text-sky-600 underline hover:text-sky-800">LINE友だち集め 月100人増やす7つの施策</Link>もご覧ください。</p>
      </section>
      ...
      <section>
        ...
        <p>Google口コミ対策の正しい運用方法については<Link href="/clinic/column/clinic-google-review" className="text-sky-600 underline hover:text-sky-800">Google口コミ対策のLINE活用</Link>で解説しています。</p>
      </section>
      ...
      <section>
        ...
        <p>Lオペ for CLINICは、デジタル紹介カード・特典自動付与・紹介追跡ダッシュボードを<Link href="/clinic/features" className="text-sky-600 underline hover:text-sky-800">標準搭載</Link>したクリニック専用LINE運用プラットフォームです。紹介制度のデジタル化で、広告費ゼロの口コミ集患を実現します。季節ごとのキャンペーン設計については<Link href="/clinic/column/clinic-seasonal-campaign" className="text-sky-600 underline hover:text-sky-800">季節別LINE配信戦略</Link>もあわせてご覧ください。</p>
      </section>
