  ...
  return (
    <ArticleLayout slug={self.slug} breadcrumbLabel="開業・経営" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <p>開業4ヶ月前からコラム記事を週2本ペースで投稿すると、開業時には30本以上の記事が蓄積され、月間1,000〜3,000のオーガニック流入を見込めます。記事は医療広告ガイドラインに準拠した内容にすることが大前提です。自費クリニックの集患チャネル全体像については<Link href="/clinic/column/self-pay-clinic-marketing-guide" className="text-sky-600 underline hover:text-sky-800">集患マーケティング完全ガイド</Link>で詳しく解説しています。</p>
      </section>
      ...
      <section>
        ...
        <p>Googleビジネスプロフィールの詳しい最適化方法は<Link href="/clinic/column/self-pay-clinic-google-meo" className="text-sky-600 underline hover:text-sky-800">Google口コミ・MEO対策ガイド</Link>で解説しています。</p>
      </section>
      ...
      <section>
        ...
        <p>開業後のリピート率向上施策については<Link href="/clinic/column/self-pay-clinic-ltv-maximize" className="text-sky-600 underline hover:text-sky-800">LTV最大化戦略</Link>で、LINE活用の詳細は<Link href="/clinic/column/self-pay-clinic-marketing-guide" className="text-sky-600 underline hover:text-sky-800">集患マーケティング完全ガイド</Link>をご覧ください。</p>
      </section>
      ...
      <section>
        ...
        <p>特にLINE公式アカウントは、開業前の友だち集めから開業後の予約管理・フォローアップまで一貫して活用できる最重要ツールです。開業3ヶ月前には開設し、あいさつメッセージ・リッチメニュー・ステップ配信の設定を完了させておきましょう。広告費の最適な配分については<Link href="/clinic/column/self-pay-clinic-ad-roi" className="text-sky-600 underline hover:text-sky-800">広告費ROI最適化ガイド</Link>で詳しく解説しています。</p>
