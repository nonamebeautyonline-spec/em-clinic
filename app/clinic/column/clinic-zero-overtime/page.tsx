  ...
  return (
    <ArticleLayout slug={self.slug} breadcrumbLabel="業務改善" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <p>クリニックのDX全体像については<Link href="/clinic/column/clinic-dx-daily-transformation" className="text-sky-600 underline hover:text-sky-800">クリニックDXの日常業務変革</Link>で詳しく解説しています。また、コスト削減の観点では<Link href="/clinic/column/clinic-cost-reduction-30man" className="text-sky-600 underline hover:text-sky-800">月30万円のコスト削減事例</Link>も参考になります。</p>
      </section>
      ...
      <section>
        ...
        <p>Lオペの導入後、予約受付をLINEに一本化し、問診もLINE上で事前に完了させる仕組みを構築。電話件数は1日50件から8件に激減し、問診の転記作業も完全に不要になりました。その結果、<strong>月40時間あった残業が大幅に削減</strong>となり、スタッフの離職率も大幅に改善しています。</p>
        ...
        <p>現在は診療終了後すぐに帰宅できる体制が整い、院長の<strong>帰宅時間は17時</strong>に。スタッフも院長が早く帰ることで「自分たちも帰りやすい」空気が生まれ、クリニック全体の残業が自然となくなりました。院長のワークライフバランスの改善は、忙しいドクターの業務効率化にとって重要なテーマです。詳しくは<Link href="/clinic/column/busy-doctor-efficiency" className="text-sky-600 underline hover:text-sky-800">忙しいドクターの業務効率化ガイド</Link>もご覧ください。</p>
      ...
      <section>
        ...
        <p>Lオペを導入して残業を解消したクリニックでは、離職率が平均<strong>65%低下</strong>。3年以上の長期勤続者が増えることで、ベテランスタッフによる質の高い患者対応が可能になり、クリニック全体のサービス品質が向上しています。スタッフ研修の効率化については<Link href="/clinic/column/clinic-staff-training" className="text-sky-600 underline hover:text-sky-800">スタッフ研修ガイド</Link>も参考になります。</p>
      ...
      <section>
        ...
        <ul className="space-y-1 text-gray-700">
          <li><Link href="/clinic/column/clinic-dx-daily-transformation" className="text-sky-600 underline hover:text-sky-800">クリニックDXの日常業務変革</Link> — DXが日々のオペレーションをどう変えるかの全体像</li>
          <li><Link href="/clinic/column/clinic-cost-reduction-30man" className="text-sky-600 underline hover:text-sky-800">月30万円のコスト削減事例</Link> — DX投資の費用対効果を詳しく解説</li>
          <li><Link href="/clinic/column/busy-doctor-efficiency" className="text-sky-600 underline hover:text-sky-800">忙しいドクターの業務効率化</Link> — 院長の労働時間を短縮する具体策</li>
          <li><Link href="/clinic/column/clinic-staff-training" className="text-sky-600 underline hover:text-sky-800">スタッフ研修ガイド</Link> — DXツール導入時の研修プログラム</li>
          <li><Link href="/clinic/contact" className="text-sky-600 underline hover:text-sky-800">無料相談・お問い合わせ</Link></li>
        </ul>
      </section>
