  ...
  return (
    <ArticleLayout slug={self.slug} breadcrumbLabel="ガイド" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <p>
          この固定費構造で特に重要なのが、<strong>Lオペ for CLINICによる業務の一元管理</strong>です。LINE予約管理、オンライン問診、セグメント配信、AI自動返信、リッチメニュー、患者CRM、配送管理、決済連携（Square）、ダッシュボード、フォローアップルール、タグ管理、テンプレートメッセージ——これらを月額10〜18万円で利用できます。個別にツールを契約する場合と比較して大幅なコスト削減になります。詳しくは<Link href="/clinic/column/clinic-cost-reduction-30man" className="text-sky-600 underline hover:text-sky-800">クリニックの固定費を月30万円削減する方法</Link>をご覧ください。
        </p>
      ...
      <section>
        ...
        />
        <p>
          AGA治療は<strong>月額課金型の安定収益</strong>が最大の魅力です。フィナステリド（月3,000〜5,000円）とミノキシジル（月5,000〜10,000円）のセット処方が主流。Lオペのフォローアップルール機能で<strong>処方タイミングに合わせた自動リマインド</strong>を送ることで、継続率を高められます。詳細は<Link href="/clinic/column/aga-online-clinic-lope" className="text-sky-600 underline hover:text-sky-800">AGA治療のオンライン診療ガイド</Link>もご覧ください。
        </p>
        ...
        />
        <p>
          ED治療は<strong>デリケートな悩みのためオンライン診療との親和性が極めて高い</strong>領域です。対面受診への心理的障壁が大きいため、オンラインでの需要が急速に拡大しています。Lオペのセグメント配信で<strong>前回処方から一定期間経過した患者に自動リマインド</strong>を送れば、リピート率が向上します。詳細は<Link href="/clinic/column/ed-online-clinic-lope" className="text-sky-600 underline hover:text-sky-800">ED治療のオンライン診療ガイド</Link>もご参照ください。
        </p>
        ...
        />
        <p>
          ピル処方は<strong>単価こそ低いものの継続率が非常に高い</strong>のが特徴です。月1回の定期処方として安定的な収益基盤になります。Lオペのタグ管理で処方サイクルを管理し、<strong>テンプレートメッセージで処方更新のタイミングを自動通知</strong>することで離脱を防げます。詳しくは<Link href="/clinic/column/pill-online-clinic-lope" className="text-sky-600 underline hover:text-sky-800">ピルのオンライン診療ガイド</Link>をご覧ください。
        </p>
      ...
      <section>
        ...
        />
        <p>
          患者200人規模では<strong>月122万円の営業利益</strong>。広告費を月20万円投じて患者獲得を加速しても、十分な利益が残ります。1日10人×週5日のペースで、診療時間は1日2〜3時間。LTV向上の戦略については<Link href="/clinic/column/self-pay-patient-ltv-maximize" className="text-sky-600 underline hover:text-sky-800">自費診療患者のLTV最大化戦略</Link>も参考にしてください。
        </p>
      ...
      <section>
        ...
        <ul className="space-y-1 text-gray-700">
          <li>
            <Link href="/clinic/column/online-clinic-complete-guide" className="text-sky-600 underline hover:text-sky-800">オンライン診療クリニック開業完全ガイド</Link> — 開設届から運営まで網羅的に解説
          </li>
          <li>
            <Link href="/clinic/column/self-pay-pricing-guide" className="text-sky-600 underline hover:text-sky-800">自費診療の価格設定ガイド</Link> — メニュー別の最適な価格戦略
          </li>
          <li>
            <Link href="/clinic/column/clinic-fixed-cost-optimization" className="text-sky-600 underline hover:text-sky-800">クリニック固定費の最適化ガイド</Link> — 固定費を徹底的に見直す手法
          </li>
          <li>
            <Link href="/clinic/column/clinic-line-roi" className="text-sky-600 underline hover:text-sky-800">LINE導入ROIの計算方法</Link> — 投資対効果を定量的に算出
          </li>
          <li>
            <Link href="/clinic/contact" className="text-sky-600 underline hover:text-sky-800">無料相談・お問い合わせ</Link> — 収支シミュレーションのご相談はこちら
          </li>
        </ul>
      </section>
