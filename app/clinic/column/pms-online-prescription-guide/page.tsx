  ...
  return (
    <ArticleLayout slug={self.slug} breadcrumbLabel="ガイド" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <p>
          漢方薬はピルが使用できない患者（喫煙者・35歳以上でBMI30以上・血栓リスクが高い方・授乳中など）にとって<strong>重要な代替選択肢</strong>です。また、ピルとの併用も可能であり、ピルで月経痛をコントロールしつつ漢方薬でPMS症状を緩和する組み合わせも有効です。漢方薬はすべて保険適用があるため、<strong>患者負担を抑えた長期処方が可能</strong>です。ピルの種類ごとの特徴については<Link href="/clinic/column/pill-types-comparison" className="text-sky-600 underline hover:text-sky-800">ピル比較ガイド</Link>で詳しく整理しています。
        </p>
      ...
      <section>
        ...
        <ul className="space-y-1 text-gray-700">
          <li>
            <Link href="/clinic/column/pill-online-clinic-lope" className="text-sky-600 underline hover:text-sky-800">ピルのオンライン処方ガイド</Link> — ピルに特化したオンライン診療の運用ノウハウ
          </li>
          <li>
          ...
          <li>
            <Link href="/clinic/column/online-clinic-prescription-rules" className="text-sky-600 underline hover:text-sky-800">オンライン診療の処方ルール</Link> — 処方日数・薬剤制限の最新情報
          </li>
          <li>
            <Link href="/clinic/column/clinic-repeat-rate-improvement" className="text-sky-600 underline hover:text-sky-800">リピート率改善ガイド</Link> — 継続処方の患者を離脱させないノウハウ
          </li>
          <li>
            <Link href="/clinic/contact" className="text-sky-600 underline hover:text-sky-800">無料相談・お問い合わせ</Link> — PMS・月経困難症オンライン外来の運用設計をご相談いただけます
          </li>
        </ul>
      </section>
