...
const faqItems = [
  { q: "ED治療のオンライン診療ガイドでLINE導入の効果はどのくらいですか？", a: "導入クリニックの実績では、予約リマインドによる無断キャンセル60〜80%削減、セグメント配信によるリピート率20〜30%向上、AI自動返信による電話対応70%削減など、多面的な効果が報告されています。" },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(jsonLd) }} />
        ...
        <section>
          ...
          <Callout type="info" title="オンライン診療の法的要件">
            2024年の診療報酬改定以降、初診からのオンライン診療が恒久化されました。ただし、ED治療薬は自費診療のため保険診療の制約を受けません。厚生労働省のガイドラインに従い、初回はビデオ診察で本人確認を行い、診療録を適切に管理していれば、2回目以降のチャット処方も適法に運用できます。オンライン診療の法規制については<Link href="/clinic/column/online-clinic-complete-guide" className="text-sky-600 underline hover:text-sky-800">オンライン診療の完全ガイド</Link>で詳しく解説しています。
          </Callout>
        </section>
        ...
        <section>
          ...
          <p>クリニックのLINE集患全般については<Link href="/clinic/column/clinic-line-revenue-growth" className="text-sky-600 underline hover:text-sky-800">クリニックの売上を上げるLINE活用術</Link>で体系的に解説しています。</p>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc pl-6 space-y-1">
            ...
            <li><Link href="/clinic/column/std-online-clinic-lope" className="text-sky-600 underline hover:text-sky-800">性感染症のオンライン診療ガイド — プライバシー配慮とLINE活用で患者体験を最適化</Link></li>
