      ...
      <section>
        ...
        <div className="rounded-2xl bg-rose-50 border-2 border-rose-200 p-6 mb-6">
          ...
          <p>
            ...
            詳しくは<Link href="/clinic/column/lstep-vs-clinic-tool" className="text-sky-600 underline hover:text-sky-800">Lステップ vs クリニック専用ツール比較</Link>を参照。
          </p>
        </div>
      </section>
      ...
      <section>
        ...
        <div className="rounded-xl bg-gradient-to-r from-blue-50 to-indigo-50 p-6 border border-blue-100 mb-6">
          ...
          <p className="text-[14px] text-gray-700 mb-0">
            ...
            詳しくは<Link href="/clinic/column/beauty-clinic-line" className="text-sky-600 underline hover:text-sky-800">美容クリニックのLINE活用事例</Link>も参考に。
          </p>
        </div>
        ...
        <div className="rounded-xl bg-gradient-to-r from-emerald-50 to-cyan-50 p-6 border border-emerald-100 mb-6">
          ...
          <p className="text-[14px] text-gray-700 mb-0">
            ...
            歯科の場合は<Link href="/clinic/column/dental-clinic-line" className="text-sky-600 underline hover:text-sky-800">歯科クリニックのLINE活用記事</Link>も参照。
          </p>
        </div>
        ...
        <div className="rounded-xl bg-gradient-to-r from-amber-50 to-orange-50 p-6 border border-amber-100 mb-6">
          ...
          <p className="text-[14px] text-gray-700 mb-0">
            ...
            オンライン診療の費用については<Link href="/clinic/column/online-medical-cost" className="text-sky-600 underline hover:text-sky-800">オンライン診療費用ガイド</Link>をご覧ください。
          </p>
        </div>
        ...
        <div className="rounded-xl bg-gradient-to-r from-rose-50 to-pink-50 p-6 border border-rose-100 mb-6">
          ...
          <p className="text-[14px] text-gray-700 mb-0">
            ...
            開業前の準備については<Link href="/clinic/column/clinic-opening-line" className="text-sky-600 underline hover:text-sky-800">開業前LINE戦略</Link>をご覧ください。
          </p>
        </div>
