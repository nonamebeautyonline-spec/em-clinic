  ...
  return (
    <ArticleLayout slug={self.slug} breadcrumbLabel="活用事例" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <p>
          不眠症による経済損失は年間約3.5兆円と推計されており、生産性低下・事故リスク・医療費増大など社会的なインパクトは極めて大きい疾患です。<strong>オンライン診療によって受診率を数%でも向上させることができれば</strong>、患者のQOL向上だけでなくクリニックの新たな収益源にもなります。オンライン診療の制度面は<Link href="/clinic/column/online-clinic-regulations" className="text-sky-600 underline hover:text-sky-800">オンライン診療の制度と規制ガイド</Link>で詳しく解説しています。
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          不眠症のオンライン診療を効率的かつ安全に運用するには、<strong>標準化されたフロー</strong>を構築することが不可欠です。特に睡眠問診は、対面診療以上に<strong>事前の情報収集を充実させる</strong>ことで、限られた診察時間を有効に活用できます。オンライン診療の全体像は<Link href="/clinic/column/online-clinic-complete-guide" className="text-sky-600 underline hover:text-sky-800">オンライン診療完全ガイド</Link>で解説しています。
        </p>
      ...
      <section>
        ...
        <ul className="space-y-1 text-gray-700">
          ...
          <li>
            <Link href="/clinic/contact" className="text-sky-600 underline hover:text-sky-800">無料相談・お問い合わせ</Link> — 不眠症オンライン診療の運用設計をご相談いただけます
          </li>
        </ul>
      </section>
