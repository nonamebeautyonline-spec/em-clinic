  ...
  return (
    <ArticleLayout slug={self.slug} breadcrumbLabel="比較" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <p>クリニック経営の競争が激化する中、患者との関係性を管理し、再診率やLTVを高めるCRM（顧客関係管理）の導入が不可欠になっています。経営課題の全体像については<Link href="/clinic/column/clinic-management-success" className="text-sky-600 underline hover:text-sky-800">クリニック経営で成功するポイント</Link>もあわせてご覧ください。</p>
      ...
      <section>
        ...
        <Callout type="success" title="CRM導入で実現できること">
          <ul className="mt-1 space-y-1">
            ...
            <li>• <strong>コミュニケーション強化</strong> — パーソナライズされたフォローアップで患者満足度向上（<Link href="/clinic/column/segment-delivery-repeat" className="text-sky-600 underline hover:text-sky-800">LINEセグメント配信でリピート率を向上</Link>も参考になります）</li>
