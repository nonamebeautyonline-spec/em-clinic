  ...
  return (
    <ArticleLayout slug={self.slug} breadcrumbLabel="業務改善" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <p><Link href="/clinic/column/segment-delivery-repeat" className="text-sky-600 underline hover:text-sky-800">セグメント配信によるリピート率向上</Link>の記事では、配信対象の絞り込み方法を詳しく解説しています。</p>
      </section>
      ...
      <section>
        ...
        <p>オンライン診療の運営全体については<Link href="/clinic/column/clinic-line-analytics" className="text-sky-600 underline hover:text-sky-800">LINE分析ダッシュボード活用ガイド</Link>で配信効果の測定方法を、<Link href="/clinic/column/clinic-cost-reduction-30man" className="text-sky-600 underline hover:text-sky-800">コスト削減30万円の実践</Link>で総合的なコスト最適化を解説しています。</p>
      </section>
