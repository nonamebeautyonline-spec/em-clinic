    ...
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(jsonLd) }} />
        ...
        <section>
          ...
          <ul className="list-disc pl-6 space-y-1 text-gray-700">
            <li><Link href="/clinic/column/diet-glp1-online-clinic-lope" className="text-emerald-700 underline">メディカルダイエットのオンライン診療ガイド — GLP-1処方とLINEフォロー体制の構築</Link></li>
            <li><Link href="/clinic/column/one-room-clinic-simulation" className="text-emerald-700 underline">ワンルームクリニック開業シミュレーション</Link></li>
            <li><Link href="/clinic/column/doctor-side-business-online-clinic" className="text-emerald-700 underline">医師の副業としてのオンラインクリニック</Link></li>
            <li><Link href="/clinic/column/self-pay-clinic-revenue-triple" className="text-emerald-700 underline">自費クリニックの売上を3倍にする方法</Link></li>
            <li><Link href="/clinic/column/online-clinic-complete-guide" className="text-emerald-700 underline">オンラインクリニック開業 完全ガイド</Link></li>
            <li><Link href="/clinic/contact" className="text-sky-600 underline hover:text-sky-800">無料相談・お問い合わせ</Link></li>
          </ul>

          <p>市場が成長している今こそ、<strong>先行者優位を確保する最大のチャンス</strong>です。まずは<Link href="/clinic/contact" className="text-sky-600 underline hover:text-sky-800">無料相談</Link>で、あなたに最適な開業プランをご提案いたします。</p>
        </section>
