  ...
  return (
    <ArticleLayout slug={self.slug} breadcrumbLabel="ガイド" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <p>オンライン診療の費用は大きく「導入時（初期費用）」と「運用時（ランニングコスト）」に分かれます。オンライン診療の仕組みや活用方法の全体像は<Link href="/clinic/column/online-medical-line" className="text-sky-600 underline hover:text-sky-800">オンライン診療×LINE</Link>で解説しています。</p>
      ...
      <section>
        ...
        <p>予約システムの選定でお悩みの方は<Link href="/clinic/column/reservation-system-comparison" className="text-sky-600 underline hover:text-sky-800">予約システム比較10選</Link>も参考にしてください。</p>
