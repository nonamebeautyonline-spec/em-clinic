...
const faqItems = [
  { q: "脂肪溶解注射（デオキシコール酸）の実際のエビデンスとGLP-1との比較はオンライン診療で処方できますか？", a: "多くの場合、オンライン診療での処方が可能です。ただし初診では処方日数に制限がある場合があります。再診であれば対面診療と同等の処方が可能です。詳しくは各薬剤の処方ルールをご確認ください。" },
    ...
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(jsonLd) }} />
        ...
        <section>
          ...
          <p>Lオペ for CLINICの月額料金は<strong>10〜18万円</strong>です。GLP-1処方件数の増加と業務効率化を考慮すると、導入による投資回収は早期に実現できます。詳しい導入フローについては、<Link href="/clinic/column/diet-glp1-online-clinic-lope" className="text-emerald-700 underline">メディカルダイエットのオンライン診療ガイド</Link>をご参照ください。</p>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc pl-6 space-y-1 text-gray-700">
            ...
            <li><Link href="/clinic/column/diet-online-clinic-winning-strategy" className="text-emerald-700 underline">ダイエットオンライン診療の勝ちパターン</Link></li>
