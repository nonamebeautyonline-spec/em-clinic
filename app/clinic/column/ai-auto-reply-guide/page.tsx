...
const self = articles.find((a) => a.slug === "ai-auto-reply-guide")!;
    ...
    <ArticleLayout slug={self.slug} breadcrumbLabel="AI自動返信" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <Callout type="success" title="AI自動返信で解決">
          24時間365日の問い合わせ対応が実現し、患者が「聞きたい」と思ったその瞬間に回答を返すことで、新患獲得率とリピート率の両方を向上させることが可能です。新患獲得の前段としてLINE友だちを増やす方法は<Link href="/clinic/column/clinic-line-friends-growth" className="text-blue-600 underline">LINE友だち集め月100人増やす7つの施策</Link>で解説しています。
        </Callout>
      </section>
      ...
      <section>
        ...
        <Callout type="success" title="スタッフの業務を半分以上削減">
          AI対応可能な問い合わせが全体の60%を占めるということは、スタッフの問い合わせ対応業務の半分以上をAIに任せられるということです。AI自動返信と組み合わせて<Link href="/clinic/column/rich-menu-design" className="text-blue-600 underline">リッチメニュー設計</Link>を最適化すると、患者のセルフサービス率をさらに高められます。
        </Callout>
      </section>
      ...
      <section>
        ...
        <ol className="list-decimal pl-6 space-y-2">
          ...
          <li><strong>スタッフ修正フィードバックで精度向上</strong> — 運用しながら学習データを蓄積し、3ヶ月で正答率90%以上へ。的外れな回答によるブロックを防ぐコツは<Link href="/clinic/column/line-block-rate-reduction" className="text-blue-600 underline">ブロック率を下げる5つの鉄則</Link>も参考になります</li>
