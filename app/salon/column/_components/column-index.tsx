    ...
    <div className="min-h-screen bg-gray-50 text-gray-800">
      ...
      <header className="sticky top-0 z-30 border-b border-gray-200/60 bg-white/95 backdrop-blur-md">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-3.5">
          <Link href="/salon" className="flex items-center gap-1.5 text-[16px] font-bold tracking-tight text-gray-900 hover:opacity-70 transition">
            Lオペ <span className="text-pink-500">for SALON</span>
          </Link>
          <div className="flex items-center gap-6">
            <Link href="/salon/about" className="hidden text-[14px] text-gray-500 hover:text-pink-600 transition md:block">Lオペ for SALONとは</Link>
            <Link href="/salon/features" className="hidden text-[14px] text-gray-500 hover:text-pink-600 transition md:block">機能一覧</Link>
            <Link href="/salon/column" className="hidden text-[14px] font-medium text-pink-600 md:block">コラム</Link>
            <Link
              href="/salon/contact"
      ...
      <div className="border-b border-gray-200 bg-white">
        <nav aria-label="パンくずリスト" className="mx-auto max-w-7xl px-6 py-3">
          <ol className="flex items-center gap-2 text-[13px] text-gray-400 list-none m-0 p-0">
            <li><Link href="/salon" className="hover:text-pink-600 transition">トップ</Link></li>
      ...
      <footer className="border-t border-gray-200 bg-white py-10">
        <div className="mx-auto max-w-7xl px-6">
          <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-between">
            ...
            <div className="flex items-center gap-6">
              <Link href="/salon" className="text-[13px] text-gray-400 hover:text-pink-600 transition">トップ</Link>
              <Link href="/salon/about" className="text-[13px] text-gray-400 hover:text-pink-600 transition">Lオペ for SALONとは</Link>
              <Link href="/salon/features" className="text-[13px] text-gray-400 hover:text-pink-600 transition">機能一覧</Link>
              <Link href="/salon/column" className="text-[13px] text-pink-600 font-medium">コラム</Link>
