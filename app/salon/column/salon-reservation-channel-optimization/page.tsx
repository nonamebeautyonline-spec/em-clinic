...
const faqItems = [
  { q: "予約チャネルが多すぎると管理が大変ではないですか？", a: "はい、チャネルが増えるほど管理の複雑さは増します。だからこそ一元管理ツールの導入が重要です。Lオペ for SALONでは、LINE予約の管理画面でLINE経由の予約を一元管理できます。" },
  ...
  return (
    <ArticleLayout slug={self.slug} breadcrumbLabel="予約チャネル最適化" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <p className="mt-4">Lオペ for SALONは、LINE予約の管理画面でLINE経由の予約を一元管理できます。最適な顧客導線の構築をサポートします。</p>
      </section>
