...
export function Footer() {
  return (
    <footer className="relative overflow-hidden bg-slate-50 px-5 py-14 text-slate-500">
      {/* 装飾 */}
      <div className="pointer-events-none absolute top-0 left-1/4 h-48 w-48 rounded-full bg-pink-500/3 blur-[80px]" />
      <div className="pointer-events-none absolute bottom-0 right-1/4 h-48 w-48 rounded-full bg-rose-500/3 blur-[80px]" />
      ...
      <div className="relative mx-auto max-w-6xl">
        ...
        <div className="grid gap-10 md:grid-cols-4">
          ...
          <div className="md:col-span-1">
            ...
            <div className="mt-3">
              <ComingSoonBadge className="text-[9px] border-pink-500/30 bg-pink-500/10 text-pink-500" />
            </div>
          </div>
          ...
          {footerLinks.map((section) => (
            <div key={section.title}>
              <h4 className="mb-3 text-[12px] font-bold tracking-wider text-slate-700 uppercase">
                {section.title}
              </h4>
                  ...
                  <li key={link.label}>
                    {"external" in link && link.external ? (
                      <a
                        ...
                        className="text-[12px] transition hover:text-pink-500"
                      >
                        {link.label}
                      </a>
                    ) : (
        ...
        <div className="my-8 flex items-center gap-3">
          ...
          <div className="h-1.5 w-1.5 rounded-full bg-pink-500/20" />
          <div className="h-px flex-1 bg-gradient-to-r from-transparent via-pink-500/15 to-transparent" />
        </div>
          ...
          <div className="text-center md:text-right">
            <p className="text-slate-400">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="underline decoration-slate-300 underline-offset-2 transition hover:text-pink-500"
              >
                株式会社ORDIX
              </a>
            </p>
