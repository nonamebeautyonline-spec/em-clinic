      ...
      <div className="mx-auto max-w-6xl">
        <div className="flex flex-col items-center justify-between gap-5 md:flex-row">
          ...
          <nav aria-label="フッターナビゲーション" className="flex flex-wrap justify-center gap-6 text-[12px]">
            <Link href="/ec/about" className="hover:text-white">Lオペ for ECとは</Link>
            ...
            <Link href="/ec/features" className="hover:text-white">機能一覧</Link>
            <Link href="/ec/column" className="hover:text-white">コラム</Link>
            <Link href="/ec/contact" className="hover:text-white">お問い合わせ</Link>
        ...
        <div className="mt-7 flex flex-col items-center justify-between gap-3 border-t border-slate-800 pt-7 text-[11px] md:flex-row">
          <div className="flex gap-5">
            <Link href="/line/terms" className="hover:text-white">利用規約</Link>
            <Link href="/line/privacy" className="hover:text-white">プライバシーポリシー</Link>
          </div>
