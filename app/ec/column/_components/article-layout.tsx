...
function KeyPoints({ points }: { points: string[] }) {
  return (
    <div className="rounded-lg border border-amber-200 bg-amber-100/60 p-5">
...
export default function ArticleLayout({ slug, breadcrumbLabel, keyPoints, toc, children }: ArticleLayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-amber-100/60 text-gray-800">
      ...
      {/* ヘッダー */}
      <header className="border-b border-gray-200/60 bg-amber-100/60 shadow-sm">
      ...
      <div className="border-b border-gray-200/60 bg-amber-100/60">
      ...
      {/* 記事ヒーロー */}
      <div className="bg-amber-100/40 pb-8">
