    ...
    <div className="min-h-screen bg-gray-50 text-gray-800">
      ...
      <footer className="bg-slate-900 py-10 text-center">
        <div className="mx-auto max-w-6xl px-6">
          <Link href="/ec" className="text-[14px] font-bold tracking-tight text-white hover:opacity-80 transition">
            Lオペ <span className="text-[11px] font-semibold text-slate-400">for EC</span>
          </Link>
          <div className="mt-4 flex items-center justify-center gap-6">
            <Link href="/ec/column" className="text-[12px] text-slate-400 hover:text-white transition">コラム一覧</Link>
            <Link href="/ec" className="text-[12px] text-slate-400 hover:text-white transition">トップ</Link>
            <Link href="/ec/features" className="text-[12px] text-slate-400 hover:text-white transition">機能一覧</Link>
            <Link href="/ec/about" className="text-[12px] text-slate-400 hover:text-white transition">Lオペ for ECとは</Link>
