...
const TRIGGER_LABELS: Record<string, string> = {
  ...
  tag_add: "タグ追加時",
  keyword: "キーワード受信時",
  reservation_made: "予約時",
  checkout_completed: "決済完了時",
  reorder_approved: "再処方承認時",
  manual: "手動登録のみ",
};
...
const TRIGGER_ICONS: Record<string, string> = {
  ...
  reservation_made: "M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z",
  checkout_completed: "M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z",
  reorder_approved: "M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z",
