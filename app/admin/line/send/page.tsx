      ...
      <div className="max-w-3xl mx-auto px-4 md:px-8 py-6 space-y-4">
        ...
        {testAccount && (
          <div className="space-y-2">
            ...
            {testResult && (
              <div className={`px-4 py-2 rounded-lg text-xs flex items-center gap-1.5 ${
                testResult.includes("完了") ? "bg-emerald-50 text-emerald-700" : "bg-red-50 text-red-700"
              }`}>
                {testResult.includes("完了") ? (
