  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between mb-4">
        <div>
          <h2 className="text-base font-bold text-gray-900">マイページ設定</h2>
          <p className="text-xs text-gray-500 mt-0.5">患者向けマイページの表示をカスタマイズ</p>
        </div>
        ...
        <div className="lg:col-span-3 space-y-6">
          ...
          <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
            <div className="px-5 py-4 border-b border-gray-100">
              <h3 className="text-sm font-bold text-gray-800">デザイン設定</h3>
          ...
          <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
            <div className="px-5 py-4 border-b border-gray-100">
              <h3 className="text-sm font-bold text-gray-800">セクション表示</h3>
          ...
          <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
            <div className="px-5 py-4 border-b border-gray-100">
              <h3 className="text-sm font-bold text-gray-800">コンテンツ設定</h3>
            ...
            <div className="p-5 space-y-4">
              ...
              <div>
                ...
                <div className="flex items-center gap-3">
                  <input type="url" value={config.content.logoUrl} onChange={(e) => updateContent("logoUrl", e.target.value)}
                    placeholder="URLを入力 または画像をアップロード"
                    className="flex-1 px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/30" />
                  <label className="shrink-0 px-3 py-2 text-xs font-medium text-blue-600 bg-blue-50 rounded-lg hover:bg-blue-100 cursor-pointer transition-colors">
                    アップロード
                ...
                {config.content.logoUrl && (
                  <div className="mt-2 p-2 bg-gray-50 rounded-lg inline-block">
                    <img src={config.content.logoUrl} alt="ロゴプレビュー" className="h-10 object-contain"
                      onError={(e) => { (e.target as HTMLImageElement).style.display = "none"; }} />
                  </div>
                )}
              </div>
              ...
              <div>
                ...
                <textarea value={config.content.supportMessage} onChange={(e) => updateContent("supportMessage", e.target.value)}
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input type="url" value={config.content.supportUrl} onChange={(e) => updateContent("supportUrl", e.target.value)}
                    className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/30" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">ボタンラベル</label>
                  <input type="text" value={config.content.supportButtonLabel} onChange={(e) => updateContent("supportButtonLabel", e.target.value)}
                    className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/30" />
                </div>
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">注釈テキスト</label>
                <input type="text" value={config.content.supportNote} onChange={(e) => updateContent("supportNote", e.target.value)}
                  className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/30" />
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
            <div className="px-5 py-4 border-b border-gray-100">
              <h3 className="text-sm font-bold text-gray-800">文言設定</h3>
            ...
            <div className="p-5 space-y-4">
              {([
                ...
                <div key={key}>
                  ...
                  <input type="text" value={config.labels[key]} onChange={(e) => updateLabel(key, e.target.value)}
                    className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/30" />
                </div>
              ))}
              <hr className="border-gray-100" />
              ...
              <div>
                ...
                <input type="text" value={config.labels.cancelNotice} onChange={(e) => updateLabel("cancelNotice", e.target.value)}
                  className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/30" />
              </div>
            </div>
          </div>
  ...
  return (
    <div className="sticky top-6">
      ...
      <div className="mx-auto w-[320px] border-[10px] border-gray-800 rounded-[36px] overflow-hidden shadow-2xl">
        ...
        <div className="h-[560px] overflow-y-auto" style={{ backgroundColor: colors.pageBg }}>
          {/* ヘッダー */}
          ...
          <div className="px-3 py-3 space-y-3">
            ...
            {sections.showReorder && (
              <div className="rounded-2xl p-3" style={{ backgroundColor: colors.primaryLight }}>
                ...
                <button style={{ backgroundColor: colors.primary }} className="mt-2 w-full text-[9px] font-medium text-white py-1.5 rounded-lg">
            ...
            {sections.showSupport && (
              <div className="bg-white rounded-2xl shadow-sm p-3">
                ...
                <button style={{ backgroundColor: colors.primary }} className="text-[9px] font-medium text-white px-3 py-1.5 rounded-lg">
