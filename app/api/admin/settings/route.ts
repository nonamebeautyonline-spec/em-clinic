...
const SETTING_DEFINITIONS: Record<SettingCategory, SettingDef[]> = {
  ...
  business_rules: [
    ...
    { key: "payment_thank_message_card", label: "決済完了メッセージ（クレカ）", sensitive: false },
    { key: "payment_thank_message_bank", label: "決済完了メッセージ（銀行振込）", sensitive: false },
    { key: "payment_thank_header_card", label: "ヘッダー（クレカ）", sensitive: false },
    { key: "payment_thank_header_bank", label: "ヘッダー（銀行振込）", sensitive: false },
    { key: "show_product_name", label: "商品名表示", sensitive: false },
    { key: "show_amount", label: "金額表示", sensitive: false },
    { key: "show_payment_method", label: "決済方法表示", sensitive: false },
    { key: "show_shipping_info", label: "配送先情報表示", sensitive: false },
    { key: "show_shipping_name", label: "配送名義表示", sensitive: false },
    { key: "show_shipping_postal", label: "郵便番号表示", sensitive: false },
    { key: "show_shipping_address", label: "住所表示", sensitive: false },
    { key: "show_shipping_phone", label: "電話番号表示", sensitive: false },
    { key: "show_shipping_email", label: "メールアドレス表示", sensitive: false },
