...
export async function POST(req: NextRequest) {
  ...
  if (error) return serverError(error.message);
  logAudit(req, "form_folder.create", "form_folder", "unknown");
...
export async function PUT(req: NextRequest) {
  ...
  if (error) return serverError(error.message);
  logAudit(req, "form_folder.update", "form_folder", String(id));
  return NextResponse.json({ ok: true, folder: data });
}
...
export async function DELETE(req: NextRequest) {
  ...
  if (error) return serverError(error.message);
  logAudit(req, "form_folder.delete", "form_folder", String(defaultFolder?.id ?? "unknown"));
