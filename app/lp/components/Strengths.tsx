...
export default function Strengths() {
  const cards = [
    { num: "01", title: "クリニック専用設計", sub: "vs. Lステップ・Liny等の汎用ツール", points: ["Lステップ・Linyなどの汎用LINE配信ツールは飲食・EC向け。医療特有の「問診→予約→診療→処方→フォロー」導線に未対応", "患者CRM・対応マーク・処方管理・配送追跡まで、クリニック業務フローに完全特化", "友だち追加時の自動問診誘導・診療後の自動フォローなど医療最適シナリオをプリセット"] },
  ...
  return (
    <Section id="strengths" className="bg-slate-900 text-white">
      <div className="text-center">
        ...
        <p className="mx-auto mb-16 max-w-2xl text-[14px] leading-relaxed text-slate-400">Lステップ・Linyなどの汎用LINEマーケツールでもなく、単なる予約システムでもない。LINE公式アカウントをクリニック業務に深く統合した「現場起点」の設計思想が、Lオペ最大の差別化です。</p>
      </div>
