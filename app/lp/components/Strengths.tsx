...
export default function Strengths() {
  const cards = [
    ...
    { num: "04", title: "すべてがLINEで自動化", sub: "患者も院長もスマホ1つで完結", points: ["予約確定・リマインド・決済完了・発送通知・追跡番号…すべてのステータス変化がLINEに自動通知。電話・メールの取りこぼしゼロ", "患者はLINEを見るだけで自分の状況を把握。問い合わせ電話が激減し、受付業務を大幅削減", "リッチメニュー・配信・自動アクションもGUIで即設定。管理画面から院長自身がすぐ反映"] },
  ];
