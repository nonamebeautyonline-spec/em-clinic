    ...
    <ArticleLayout slug={self.slug} breadcrumbLabel="医薬品解説" keyPoints={keyPoints} toc={[]}>
      ...
      <section>
        ...
        <Callout type="point" title="もっと詳しく知りたい方へ">
          GLP-1受容体作動薬の<strong>安全性エビデンス</strong>については<Link href="/lp/column/glp1-diet-safety-evidence" className="text-emerald-700 underline">「GLP-1ダイエットは危険？ — 臨床エビデンスから安全性を検証」</Link>、リベルサスの<strong>副作用と対処法</strong>については<Link href="/lp/column/rybelsus-side-effects-guide" className="text-emerald-700 underline">「リベルサスの副作用ガイド」</Link>、<strong>用量調整と服用方法</strong>の詳細は<Link href="/lp/column/rybelsus-effective-dosing" className="text-emerald-700 underline">「リベルサスの効果的な服用ガイド」</Link>をあわせてご覧ください。
        </Callout>
      </section>
    </ArticleLayout>
  );
