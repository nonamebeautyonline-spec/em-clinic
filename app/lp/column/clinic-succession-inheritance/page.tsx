    ...
    <ArticleLayout slug={slug} breadcrumbLabel="経営戦略" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <ul className="space-y-1 text-gray-700">
          <li>
            <Link href="/lp/column/doctor-asset-management-tax" className="text-sky-600 underline hover:text-sky-800">開業医の資産運用と節税対策</Link> — 所得分散・法人活用の基本
          </li>
          <li>
            <Link href="/lp/column/clinic-opening-fund-guide" className="text-sky-600 underline hover:text-sky-800">クリニック開業資金の調達方法</Link> — 承継者側の資金計画
          </li>
          <li>
            <Link href="/lp/column/clinic-management-success" className="text-sky-600 underline hover:text-sky-800">クリニック経営成功の秘訣</Link> — 承継価値を高める経営
          </li>
          <li>
            <Link href="/lp/column/clinic-data-migration" className="text-sky-600 underline hover:text-sky-800">データ移行ガイド</Link> — 承継時のシステム引継ぎ
          </li>
          <li>
