  ...
  return (
    <ArticleLayout slug={self.slug} breadcrumbLabel="マーケティング" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <p>注目すべきは、<strong>最大の理由が「忘れていた」（40%）</strong>であること。つまり、不満があったわけでもなく、競合に奪われたわけでもなく、単に「思い出すきっかけがなかった」だけで再来院に至っていないのです。</p>
      ...
      <section>
        ...
        <p>手動でのフォローアップ（電話・ハガキ・メール作成）に月間約30時間かかっていた作業が、Lオペの自動化により<strong>月2時間</strong>にまで削減されます。残りの28時間を診療や他の業務改善に充てることで、クリニック全体の生産性が向上します。</p>
