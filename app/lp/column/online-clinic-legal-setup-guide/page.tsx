  ...
  return (
    <ArticleLayout slug={self.slug} breadcrumbLabel="ガイド" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <p>
          なお、初診からのオンライン診療において<strong>麻薬・向精神薬の処方は禁止</strong>されています。再診であっても、オンライン診療で麻薬を処方する場合は慎重な判断が求められ、対面診療での状態確認が原則として必要です。法規制の詳細は<Link href="/lp/column/online-clinic-regulations" className="text-sky-600 underline hover:text-sky-800">法規制と薬機法ガイド</Link>で解説しています。
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          開業直後はスタッフも少なく、院長一人で診察から事務作業までこなすケースも珍しくありません。LINEを活用した業務自動化により、<strong>少人数でも効率的にクリニック運営</strong>を行うことが可能です。オンライン診療の運用全体像は<Link href="/lp/column/online-clinic-complete-guide" className="text-sky-600 underline hover:text-sky-800">オンライン診療完全ガイド</Link>で詳しく解説しています。
        </p>
      ...
      <section>
        ...
        <p>
          法的手続きを適切に完了させることは、クリニックの信頼性の基盤です。開設届から診療開始までの一連の流れを正しく理解し、余裕を持ったスケジュールで準備を進めましょう。開業後の運用効率化にはLオペ for CLINICをぜひご検討ください。オンライン診療の全体像は<Link href="/lp/column/online-clinic-complete-guide" className="text-sky-600 underline hover:text-sky-800">オンライン診療完全ガイド</Link>、法規制の詳細は<Link href="/lp/column/online-clinic-regulations" className="text-sky-600 underline hover:text-sky-800">法規制と薬機法ガイド</Link>もあわせてご参照ください。お問い合わせは<Link href="/lp/contact" className="text-sky-600 underline hover:text-sky-800">こちら</Link>から。
        </p>
      </section>
    </ArticleLayout>
  );
