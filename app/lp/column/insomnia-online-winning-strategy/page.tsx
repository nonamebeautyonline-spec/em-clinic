    ...
    >
      ...
      <section>
        ...
        <p>
          ...
          オンライン診療の制度面は
          <Link
            href="/lp/column/online-clinic-regulations"
      ...
      <section>
        ...
        <p>
          ...
          価格設定の詳細は
          <Link
            href="/lp/column/self-pay-pricing-guide"
            className="text-sky-600 underline hover:text-sky-800"
          >
            自費クリニック価格設定ガイド
          </Link>
      ...
      <section>
        ...
        <p>
          ...
          詳しくは
          <Link
            href="/lp/column/clinic-repeat-rate-improvement"
            className="text-sky-600 underline hover:text-sky-800"
          >
            リピート率改善ガイド
          </Link>
      ...
      <section>
        ...
        <p>
          ...
          広告規制の詳細は
          <Link
            href="/lp/column/clinic-ad-yakki-ho-guide"
            className="text-sky-600 underline hover:text-sky-800"
          >
            薬機法・医療広告ガイド
          </Link>
      ...
      <section>
        ...
        <p>
          ...
          Dr1人運営の全体像は
          <Link
            href="/lp/column/one-room-clinic-simulation"
            className="text-sky-600 underline hover:text-sky-800"
          >
            1室開業シミュレーション
          </Link>
      ...
      <section>
        ...
        <p>
          ...
          開業全体のコスト構造については
          <Link
            href="/lp/column/clinic-fixed-cost-optimization"
            className="text-sky-600 underline hover:text-sky-800"
          >
            固定費最適化ガイド
          </Link>
      ...
      <section>
        ...
        <ul className="space-y-1 text-gray-700">
          <li>
            <Link
              href="/lp/column/insomnia-online-clinic-lope"
              className="text-sky-600 underline hover:text-sky-800"
            >
              不眠症・睡眠薬のオンライン処方ガイド
            </Link>{" "}
          ...
          <li>
            <Link
              href="/lp/column/online-clinic-complete-guide"
              className="text-sky-600 underline hover:text-sky-800"
            >
              オンライン診療完全ガイド
            </Link>{" "}
          ...
          <li>
            <Link
              href="/lp/column/doctor-side-business-online-clinic"
              className="text-sky-600 underline hover:text-sky-800"
            >
              医師の副業オンラインクリニック
            </Link>{" "}
