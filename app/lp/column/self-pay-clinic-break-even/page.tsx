    ...
    <ArticleLayout slug={slug} breadcrumbLabel="経営戦略" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <ul className="space-y-1 text-gray-700">
          <li>
            <Link href="/lp/column/clinic-fixed-cost-optimization" className="text-sky-600 underline hover:text-sky-800">固定費最適化ガイド</Link> — 固定費を構造的に削減する方法
          </li>
          <li>
            <Link href="/lp/column/self-pay-clinic-revenue-triple" className="text-sky-600 underline hover:text-sky-800">自費クリニック売上3倍の秘訣</Link> — 客単価とLTV向上の実践法
          </li>
          <li>
            <Link href="/lp/column/clinic-kpi-dashboard" className="text-sky-600 underline hover:text-sky-800">KPIダッシュボード構築</Link> — 経営指標の可視化方法
          </li>
          <li>
            <Link href="/lp/column/self-pay-clinic-repeat-prescription-revenue" className="text-sky-600 underline hover:text-sky-800">リピート処方で安定収益を作る方法</Link> — ストック型収益の構築
          </li>
          <li>
            <Link href="/lp/contact" className="text-sky-600 underline hover:text-sky-800">無料相談・お問い合わせ</Link> — 収支改善のご相談はこちら
          </li>
        </ul>
      </section>
    </ArticleLayout>
