...
export default function Page() {
  return (
    <ArticleLayout slug={self.slug} breadcrumbLabel="ツール比較" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        <h2 id="pitfall" className="text-xl font-bold text-slate-800">クリニックがLINE配信ツールを選ぶ際の落とし穴</h2>
      ...
      <section>
        <h2 id="comparison" className="text-xl font-bold text-slate-800">比較表: 汎用ツール vs クリニック専用ツール</h2>
      ...
      <section>
        <h2 id="generic-use-case" className="text-xl font-bold text-slate-800">Lステップ・Linyが向いているケース</h2>
      ...
      <section>
        <h2 id="why-clinic-tool" className="text-xl font-bold text-slate-800">クリニック専用ツールが必要な理由</h2>
      ...
      <section>
        <h2 id="cost" className="text-xl font-bold text-slate-800">費用の違い: 複数SaaS vs オールインワン</h2>
      ...
      <section>
        <h2 id="summary" className="text-xl font-bold text-slate-800">まとめ: クリニックには専用ツールを選ぶべき</h2>
