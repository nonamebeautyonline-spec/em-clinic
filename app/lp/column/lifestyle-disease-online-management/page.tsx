  ...
  return (
    <ArticleLayout slug={self.slug} breadcrumbLabel="経営戦略" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <p>最もオンライン管理に適した疾患です。降圧薬の処方は比較的シンプルで、家庭血圧計による自己測定が普及しているため、対面での身体診察の頻度を下げやすい特徴があります。初診と年1〜2回の対面診察で血液検査・心電図を実施し、それ以外はオンラインで処方を継続するモデルが標準的です。</p>
      ...
      <section>
        ...
        <p>24ヶ月目には月間売上300万円超、累積患者380名の安定基盤が構築されます。生活習慣病患者は「治る」疾患ではなく長期管理が前提のため、離脱さえ防げば患者数は右肩上がりで積み上がります。この「減りにくさ」がストック型モデルの最大の強みです。</p>
      ...
      <section>
        ...
        <p>成功の鍵は、①対面とオンラインの適切な使い分け設計、②LINEを活用した服薬リマインドと検査値フィードバック、③処方切れを防ぐ自動リマインド体制の3点です。患者基盤が積み上がるほどストック収益が増加する構造を早期に構築し、新規獲得と離脱防止の両輪でクリニックの持続的成長を実現しましょう。</p>
