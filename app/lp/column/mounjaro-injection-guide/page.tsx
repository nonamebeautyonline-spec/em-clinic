  ...
  return (
    <ArticleLayout slug={self.slug} breadcrumbLabel="医薬品解説" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <img src="/lp/column/images/mounjaro/1814993947313537264-GTAjzztbIAA8uJx.jpg" alt="マンジャロ アテオスの使い方手順" className="rounded-xl my-4 w-full" />
      ...
      <section>
        ...
        <img src="/lp/column/images/mounjaro/1831742544939720775-GWuoIpCaQAAZDwG.jpg" alt="マンジャロ注射の成功確認方法" className="rounded-xl my-4 w-full" />
      </section>
      ...
      <section>
        ...
        <p>マンジャロの基本について知りたい方は<Link href="/lp/column/mounjaro-complete-guide" className="text-sky-600 underline hover:text-sky-800">マンジャロとは？初心者向け入門ガイド</Link>を、副作用が気になる方は<Link href="/lp/column/mounjaro-side-effects-guide" className="text-sky-600 underline hover:text-sky-800">マンジャロの副作用と対処法</Link>をご覧ください。リバウンド対策は<Link href="/lp/column/mounjaro-rebound-prevention" className="text-sky-600 underline hover:text-sky-800">マンジャロとリバウンド</Link>で解説しています。</p>
      </section>
