  ...
  return (
    <ArticleLayout slug={self.slug} breadcrumbLabel="活用事例" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <p>
          PIT管理患者が50人に達した場合、<strong>月間約18〜20万円の収益</strong>が見込めます。PIT療法は定期フォローの頻度が3〜6か月に1回と比較的低いため、医師の診察時間あたりの効率が高い点が特徴です。性器ヘルペス患者の中にはSTD検査の定期的なニーズもあるため、<Link href="/lp/column/std-online-clinic-lope" className="text-sky-600 underline hover:text-sky-800">性感染症オンライン診療</Link>と組み合わせた包括的な診療メニューの構築も有効です。
        </p>
      </section>
      ...
      <section>
        ...
        <ul className="space-y-1 text-gray-700">
          <li>
            <Link href="/lp/column/std-online-clinic-lope" className="text-sky-600 underline hover:text-sky-800">性感染症のオンライン診療ガイド</Link> — 性器ヘルペスを含むSTDオンライン診療の全体像
          </li>
          <li>
            <Link href="/lp/column/online-clinic-prescription-rules" className="text-sky-600 underline hover:text-sky-800">オンライン診療の処方ルール</Link> — 抗ウイルス薬を含む処方日数・制限の最新情報
          </li>
          <li>
          ...
          <li>
            <Link href="/lp/column/clinic-repeat-rate-improvement" className="text-sky-600 underline hover:text-sky-800">リピート率改善ガイド</Link> — 継続患者を離脱させないフォロー術
          </li>
          <li>
