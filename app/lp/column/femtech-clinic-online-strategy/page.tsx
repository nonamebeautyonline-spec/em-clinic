  ...
  return (
    <ArticleLayout slug={self.slug} breadcrumbLabel="経営戦略" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <p>自費ピル処方の場合、月額2,000〜4,000円が相場です。これにシステム利用料・配送料を加えて月額3,000〜5,500円の設定が一般的です。利益率は75〜85%と非常に高く、<Link href="/lp/column/pill-online-clinic-winning-strategy" className="text-emerald-700 underline">ピルオンラインクリニックの詳細戦略</Link>で解説している通り、Dr1人で月間300〜500名の処方管理が可能です。</p>
      ...
      <section>
        ...
        <p>更年期領域のオンライン診療は、初診時に症状の詳細ヒアリングと血液検査（女性ホルモン値の確認）を対面または提携検査機関で実施し、以降はオンラインで処方を継続するフローが推奨されます。処方薬の月額は自費の場合3,000〜8,000円（HRT）、2,000〜5,000円（漢方）が相場です。</p>
      ...
      <section>
        ...
        <p>参入に際しては、まずピル処方の単一領域でオペレーションを確立し、その後に更年期ケア・妊活サポートへ横展開する段階的アプローチが現実的です。LINEを活用した服薬リマインドと体調管理の自動化は、患者体験の向上とスタッフ工数の削減を両立させる実践的な手段として有効です。</p>
