...
const keyPoints = [
  ...
  "AGA・ED・ピル・美容内服・GLP-1ダイエットの自費市場は年平均8〜15%で成長中",
  ...
  return (
    <ArticleLayout slug={SLUG} breadcrumbLabel="経営戦略" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <p>注目すべきは、いずれの分野も<strong>年平均8〜20%で成長</strong>している点です。保険診療の市場が横ばい〜微減傾向であるのとは対照的に、自費診療市場は需要拡大フェーズにあります。特にGLP-1ダイエット市場は年20%近い成長率で、今後数年でさらに拡大が見込まれます。</p>
