  ...
  return (
    <ArticleLayout slug={self.slug} breadcrumbLabel="ガイド" keyPoints={keyPoints} toc={toc}>
      ...
      <p className="text-[15px] leading-relaxed text-gray-700 font-medium bg-blue-50 rounded-xl p-5 border border-blue-100">
        ...
        セグメント配信の基本は<Link href="/lp/column/segment-delivery-repeat" className="text-sky-600 underline hover:text-sky-800">セグメント配信でリピート率を向上させる方法</Link>も併せてご確認ください。
      </p>
      ...
      <section>
        ...
        <p>
          LINE運用の自動化全般については<Link href="/lp/column/clinic-line-automation" className="text-sky-600 underline hover:text-sky-800">クリニックのLINE自動化ガイド</Link>で詳しく解説しています。
        </p>
      </section>
      ...
      <section>
        ...
        <Callout type="info" title="タグのスリム化が配信精度を高める">
          ...
          CRM全体の比較は<Link href="/lp/column/clinic-crm-comparison" className="text-sky-600 underline hover:text-sky-800">クリニック向けCRMツール比較</Link>で解説しています。
        </Callout>
      </section>
      ...
      <section>
        ...
        <p>
          ...
          LINE運用全体の自動化については<Link href="/lp/column/clinic-line-automation" className="text-sky-600 underline hover:text-sky-800">クリニックのLINE自動化ガイド</Link>も併せてご確認ください。
        </p>
      </section>
