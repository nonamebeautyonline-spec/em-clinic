  ...
  return (
    <ArticleLayout slug={self.slug} breadcrumbLabel="ガイド" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <p>LINE自動化で属人化を防ぐ方法は<Link href="/lp/column/clinic-line-automation" className="text-sky-600 underline hover:text-sky-800">LINE自動化完全ガイド</Link>で詳しく解説しています。</p>
      </section>
      ...
      <section>
        ...
        <p>マニュアルは「読んでわかる」ではなく「見てわかる」形式にすることがポイントです。スクリーンショットを多用し、手順を番号付きで記載しましょう。リッチメニューの設計方法は<Link href="/lp/column/rich-menu-design" className="text-sky-600 underline hover:text-sky-800">リッチメニュー設計の5つのポイント</Link>も参考になります。</p>
      ...
      <section>
        ...
        <p>セキュリティ対策の詳細は<Link href="/lp/column/clinic-line-security" className="text-sky-600 underline hover:text-sky-800">LINE運用セキュリティガイド</Link>をご覧ください。</p>
      </section>
