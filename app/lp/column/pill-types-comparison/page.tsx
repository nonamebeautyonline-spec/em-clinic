  ...
  return (
    <ArticleLayout slug={self.slug} breadcrumbLabel="ガイド" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <p><Link href="/lp/column/pill-online-clinic-lope" className="text-emerald-700 underline">ピル処方のオンライン診療ガイド</Link>で詳しく解説している通り、ピル処方はオンライン診療と非常に相性が良い領域であり、LEP・OCの両方を取り扱える体制を構築することが収益最大化のポイントです。</p>
      </section>
      ...
      <section>
        ...
        <p><Link href="/lp/column/pill-online-clinic-winning-strategy" className="text-emerald-700 underline">ピル処方オンラインクリニックの運営戦略</Link>でも詳述しているように、ピルの定期処方は安定したリカーリング収益の源泉です。LINEフォローによる継続率向上は、収益と患者満足度の両方を高める最も効果的な施策の一つです。</p>
      </section>
