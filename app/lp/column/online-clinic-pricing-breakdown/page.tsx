  ...
  return (
    <ArticleLayout slug={self.slug} breadcrumbLabel="ガイド" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <p>この4つの費用項目をどう組み合わせ、どの項目を患者に明示するかによって、患者の「割高感」と「納得感」が大きく変わります。特にシステム利用料の設計は悩ましいポイントであり、<Link href="/lp/column/online-clinic-system-fee-design" className="text-sky-600 underline hover:text-sky-800">システム利用料の具体的な設計パターンと相場</Link>も参考にしてください。以降のセクションでは、保険診療・自費診療それぞれの具体的な相場と設計ポイントを見ていきましょう。</p>
      </section>
      ...
      <section>
        ...
        <p><strong>1. システム月額利用料。</strong>オンライン診療プラットフォームの月額費用は、無料プランから月額数万円まで幅があります。無料プランは機能制限があり、予約・決済・配送を別々のツールで管理する手間が発生するため、<Link href="/lp/column/online-clinic-app-comparison" className="text-sky-600 underline hover:text-sky-800">オンライン診療システムの機能・コスト比較</Link>を踏まえたトータルコストで比較することが重要です。</p>

        <p><strong>2. 決済手数料。</strong>クレジットカード決済の手数料は3.0〜3.6%が一般的です。月間売上300万円のクリニックなら、決済手数料だけで月9〜11万円のコストになります。</p>

        <p><strong>3. 配送コスト。</strong>薬の配送を内製化する場合、梱包資材費・送料・人件費がかかります。レターパックで約370〜520円、宅急便で約700〜1,000円。月100件の配送で5〜10万円のコストです。配送フロー全体の設計については<Link href="/lp/column/online-clinic-prescription-delivery-flow" className="text-sky-600 underline hover:text-sky-800">処方箋・配送フローの3パターン比較</Link>で詳しく解説しています。</p>
