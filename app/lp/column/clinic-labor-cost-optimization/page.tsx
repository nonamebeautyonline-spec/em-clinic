  ...
  return (
    <ArticleLayout slug={slug} breadcrumbLabel="経営戦略" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <p>
          人件費最適化の第一歩は<strong>「人がやる必要がある業務」と「機械に任せられる業務」</strong>を明確に切り分けることです。電話対応の70%、問診票の記入・転記、リマインド連絡、一般的な問い合わせ対応——これらはDXで自動化可能です。一方、患者とのコミュニケーション、医療判断、クレーム対応は人間にしかできません。この切り分けを行った上で、人の配置を最適化していきます。
        </p>
      ...
      <section>
        ...
        <p>
          タスクシフトにより<strong>医師の1日あたりの診療時間が約1時間増加</strong>すると、その分追加で患者を診ることが可能になります。仮に1人あたりの売上が1.5万円なら、1日4人の追加診療で月132万円の増収効果です。人件費を増やさずに売上を伸ばせるため、人件費率が大幅に改善されます。
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          離職の主な原因は「給与への不満」よりも<strong>「業務負荷の偏り」「人間関係」「成長実感の欠如」</strong>であることが多いです。DXによる業務負荷の平準化は、離職防止にも直結します。紙の問診票の転記作業やリマインド電話のような「やりがいを感じにくい定型業務」を自動化し、スタッフが患者対応に集中できる環境を作ることが、モチベーションの維持と離職防止に効果的です。
        </p>
