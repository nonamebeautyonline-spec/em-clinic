  ...
  return (
    <ArticleLayout slug={self.slug} breadcrumbLabel="経営戦略" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <p>なぜこれほど未受診者が多いのか。民間調査では、性感染症の疑いがあっても<strong>「受診しなかった・先延ばしにした」と回答した割合が62%</strong>に達しました。理由の上位は「恥ずかしい」「待合室で人に見られたくない」「受付で症状を言いたくない」です。これは裏返すと、<strong>心理的バリアさえ取り除けば受診する意思はある</strong>ということであり、オンライン診療が最も効果を発揮する領域です。患者満足度を高めるオンライン診療の設計については<Link href="/lp/column/telemedicine-patient-satisfaction" className="text-sky-600 underline hover:text-sky-800">患者満足度向上ガイド</Link>で、自費オンライン診療のルールは<Link href="/lp/column/self-pay-online-clinic-rules" className="text-sky-600 underline hover:text-sky-800">自費オンライン診療ルールガイド</Link>で解説しています。</p>
