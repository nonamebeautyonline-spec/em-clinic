  ...
  return (
    <ArticleLayout slug={self.slug} breadcrumbLabel="ガイド" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <p>実務上、同意書の整備は<strong>医療訴訟リスクの軽減</strong>だけでなく、患者への説明プロセスの標準化にも寄与します。担当医が変わっても一定水準の説明が行われ、患者が「聞いていなかった」という事態を防止できます。</p>
      </section>
      ...
      <section>
        ...
        <p><strong>費用に関する事項</strong>として、診察料、システム利用料（通信費）、処方料、薬剤配送料など、患者が負担する費用の内訳を明確に記載します。「想定していなかった費用を請求された」というクレームは、費用の事前説明で大部分を防止できます。</p>
      </section>
      ...
      <section>
        ...
        <p>特定商取引法の<strong>通信販売</strong>に該当する場合は、同法に基づく表示義務（事業者情報、返品特約等）も必要です。オンライン診療における薬剤処方が通信販売に該当するかは個別判断ですが、自費の定期購入型サービスでは該当する可能性が高いため、念のため対応しておくことが安全です。</p>
      </section>
