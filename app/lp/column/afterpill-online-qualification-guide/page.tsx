  ...
  return (
    <ArticleLayout slug={self.slug} breadcrumbLabel="ガイド" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <p>
          処方時には、服用後<strong>3週間を経過しても月経が来ない場合の妊娠検査</strong>と、<strong>産婦人科への対面受診</strong>を必ず勧奨する義務があります。また、今後の避妊方法について低用量ピルやIUD（子宮内避妊具）など、より確実な方法への移行を提案することも推奨されています。アフターピルのオンライン診療フローの全体像は<Link href="/lp/column/afterpill-online-clinic-guide" className="text-sky-600 underline hover:text-sky-800">アフターピルのオンライン診療ガイド</Link>で詳しく解説しています。
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          エラ（ウリプリスタル酢酸エステル）など、レボノルゲストレル以外の緊急避妊薬が日本で承認された場合、オンライン処方の対象薬剤が拡大する可能性があります。新たな薬剤が追加された場合は、研修内容や処方要件が更新されることが予想されます。婦人科領域全体のオンライン診療については<Link href="/lp/column/gynecology-online-clinic-guide" className="text-sky-600 underline hover:text-sky-800">婦人科オンライン診療の始め方</Link>も参考になります。
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          オンラインでのアフターピル処方を検討するクリニックは、まず医師の資格要件を確認し、必要に応じて研修を受講した上で、処方体制を整えましょう。ピル処方全般のオンライン診療については<Link href="/lp/column/pill-online-clinic-lope" className="text-sky-600 underline hover:text-sky-800">ピル処方のオンライン診療ガイド</Link>、オンライン診療の法規制全般は<Link href="/lp/column/online-clinic-regulations" className="text-sky-600 underline hover:text-sky-800">オンライン診療の法規制ガイド</Link>もご参照ください。お問い合わせは<Link href="/lp/contact" className="text-sky-600 underline hover:text-sky-800">こちら</Link>から。
        </p>
      </section>
    </ArticleLayout>
  );
