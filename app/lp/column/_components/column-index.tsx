...
const categoryStyles: Record<string, { pill: string }> = {
  ...
  "ツール・システム比較": { pill: "bg-cyan-50 text-cyan-600 ring-cyan-200/50" },
  "医薬品・処方ガイド":   { pill: "bg-emerald-50 text-emerald-600 ring-emerald-200/50" },
};
...
/* ─── 人気タグ ─── */
const popularTags = [
  "LINE公式アカウント", "クリニックDX", "予約管理", "セグメント配信",
  "オンライン問診", "AI自動返信", "リッチメニュー", "電子カルテ",
  "無断キャンセル対策", "患者フォロー",
];
        ...
        <div className="flex gap-10">
          ...
          <main className="min-w-0 flex-1">
            ...
            <div className="mt-14 overflow-hidden rounded-2xl bg-gradient-to-br from-blue-50 via-indigo-50 to-violet-50 p-10 text-center ring-1 ring-blue-100 md:p-14">
              <p className="text-[12px] font-bold tracking-widest text-blue-400 uppercase">Lオペ for CLINIC</p>
              <h2 className="mt-3 text-[22px] font-bold text-gray-800 md:text-[26px]">LINE公式アカウントでクリニック業務をDX化</h2>
