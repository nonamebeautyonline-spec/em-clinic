    ...
    <ArticleLayout slug={self.slug} breadcrumbLabel="活用事例" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <Callout type="point" title="セットメニューの効果">
          「レーザー施術＋美白内服3ヶ月セット」のように対面施術とオンライン処方をパッケージ化して提示すると、患者は「3ヶ月間ケアしてもらえる」という安心感を得られます。単体メニューよりもセットの方が処方継続率が高くなる傾向があり、客単価の向上にも寄与します。セット処方の具体的な組み合わせパターンは<Link href="/lp/column/beauty-oral-set-prescription" className="text-sky-600 underline hover:text-sky-800">美容内服セット処方ガイド</Link>を参照してください。
        </Callout>
      </section>
