    ...
    <ArticleLayout slug={self.slug} breadcrumbLabel="ガイド" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <Callout type="info" title="「クリニック専用設計」だからこそできること">
          Lオペは、患者CRM・問診フォーム・カルテ連携・処方管理・配送追跡といった医療業務に必要な機能を標準搭載。汎用ツールでは別途開発や外部連携が必要な機能が、最初からすべて揃っています。
        </Callout>
        ...
        <p>
          汎用ツールとの詳しい機能比較は<Link href="/lp/column/lstep-vs-clinic-tool" className="text-emerald-700 underline">Lステップ・Liny vs クリニック専用ツール徹底比較</Link>でも解説しています。
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          各機能の詳細は<Link href="/lp/features" className="text-sky-600 underline hover:text-sky-800">機能一覧ページ</Link>をご覧ください。クリニックDXの全体像を知りたい方は<Link href="/lp/column/clinic-dx-complete-guide" className="text-emerald-700 underline">クリニックDX完全ガイド</Link>も参考になります。
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          さらに多くの活用事例を<Link href="/lp/column/clinic-line-case-studies" className="text-emerald-700 underline">クリニックのLINE公式アカウント活用事例5選</Link>で紹介しています。
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          詳しい料金プランや見積もりは<Link href="/lp/contact" className="text-sky-600 underline hover:text-sky-800">お問い合わせページ</Link>からお気軽にご相談ください。
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          Lステップとの詳しい比較は<Link href="/lp/column/lstep-vs-clinic-tool" className="text-emerald-700 underline">Lステップ・Liny vs クリニック専用ツール徹底比較</Link>をご覧ください。
        </p>
      </section>
      ...
      <section>
        ...
        <ul className="list-disc pl-5 space-y-1 text-[14px]">
          <li><Link href="/lp/column/lstep-vs-clinic-tool" className="text-emerald-700 underline">Lステップ・Liny vs クリニック専用ツール徹底比較</Link></li>
          <li><Link href="/lp/column/clinic-line-case-studies" className="text-emerald-700 underline">クリニックのLINE公式アカウント活用事例5選</Link></li>
          <li><Link href="/lp/column/clinic-line-revenue-growth" className="text-emerald-700 underline">LINE公式アカウントでクリニックの売上を伸ばす方法</Link></li>
          <li><Link href="/lp/column/clinic-dx-complete-guide" className="text-emerald-700 underline">クリニックDX完全ガイド</Link></li>
        </ul>
