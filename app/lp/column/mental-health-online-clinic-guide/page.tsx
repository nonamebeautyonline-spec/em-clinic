  ...
  return (
    <ArticleLayout slug={self.slug} breadcrumbLabel="ガイド" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <p>
          ただし、メンタルヘルスのオンライン診療には<strong>対面診療にはない固有の注意点</strong>があります。自殺リスクの評価が対面より難しいこと、非言語的コミュニケーション（表情・姿勢・目の動き等）の把握が限定的であること、処方薬の乱用・転売リスクへの配慮が必要なことなどです。これらを踏まえ、<strong>オンラインで安全に対応可能な範囲を明確にする</strong>ことが重要です。
        </p>
      ...
      <section>
        ...
        <p>
          管理患者80人の場合、<strong>月間約47万円の収益</strong>が見込めます。メンタルヘルス疾患は治療が長期にわたるため患者の積み上げが容易であり、150人で月間80万円超、200人で月間100万円超の安定収益となります。不眠症は特にオンライン診療との親和性が高く、<strong>「不眠症オンライン外来」として特化することで効率的な集患</strong>が可能です。
        </p>
      </section>
