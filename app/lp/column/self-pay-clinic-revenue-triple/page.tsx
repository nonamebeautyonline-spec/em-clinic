  ...
  return (
    <ArticleLayout slug={SLUG} breadcrumbLabel="マーケティング" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <p>しかし、自費診療の患者は保険診療と異なり「定期的に通う動機」が弱いことが多く、1回施術を受けて満足すると離脱してしまうケースが少なくありません。LINEを活用した再診率向上の具体策は<Link href="/lp/column/self-pay-clinic-line-revisit" className="text-sky-600 underline hover:text-sky-800">LINE再診率2倍ガイド</Link>で詳しく解説しています。ここでLINEフォローアップの出番です。</p>
