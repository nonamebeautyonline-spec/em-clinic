  ...
  return (
    <ArticleLayout slug={self.slug} breadcrumbLabel="医薬品解説" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <img src="/lp/column/images/mounjaro/1802701961789309137-GQR74M_asAAzs40.jpg" alt="マンジャロ（チルゼパチド）の基本解説" className="rounded-xl my-4 w-full" />
      ...
      <section>
        ...
        <img src="/lp/column/images/mounjaro/1802701961789309137-GQR74M8bMAAtAt4.jpg" alt="GIP/GLP-1デュアルの作用機序" className="rounded-xl my-4 w-full" />
      </section>
      ...
      <section>
        ...
        <p>マンジャロの大きなアドバンテージは<strong>減量効果の圧倒的な差</strong>です。ただし、「まず注射なしで試したい」という方にはリベルサスが合っていますし、セマグルチドで安定した実績を重視するならオゼンピックも良い選択肢です。詳しくは<Link href="/lp/column/glp1-medication-comparison" className="text-sky-600 underline hover:text-sky-800">GLP-1受容体作動薬の種類比較</Link>も参考にしてください。</p>

        <img src="/lp/column/images/mounjaro/1802701961789309137-GQR74NIaIAAbs-a.jpg" alt="GLP-1薬の比較" className="rounded-xl my-4 w-full" />
      </section>
      ...
      <section>
        ...
        <p>特に「やめたら太る」「筋肉が落ちる」「髪が抜ける」あたりは心配される方が多いですが、いずれも<strong>正しく理解すれば対策できる</strong>ものです。副作用について詳しく知りたい方は<Link href="/lp/column/mounjaro-side-effects-guide" className="text-sky-600 underline hover:text-sky-800">マンジャロの副作用と対処法</Link>をご覧ください。</p>
      </section>
