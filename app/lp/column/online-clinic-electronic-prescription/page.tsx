  ...
  return (
    <ArticleLayout slug={self.slug} breadcrumbLabel="ガイド" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <p>
          その他の注意点として、電子処方箋の有効期限は紙の処方箋と同じく<strong>発行日を含めて4日間</strong>です。オンライン診療で処方箋を発行した後、患者が4日以内に薬局で受け取らないと無効になります。Lオペの配送管理ステータスに連動したLINEリマインド通知で、薬の受け取り忘れを防止できます。
        </p>
        <p>
