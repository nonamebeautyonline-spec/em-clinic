  ...
  return (
    <ArticleLayout slug={self.slug} breadcrumbLabel="ガイド" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <p>一方で、AGA治療は<strong>継続こそが命</strong>です。6ヶ月以上の服薬継続が効果実感の前提であり、中断すれば数ヶ月で元の状態に戻ります。ジェネリックを活用したコスト最適化、オンライン処方による利便性向上、そしてLINEを活用した定期フォローの3本柱で、患者の治療継続をサポートする体制を構築することが、クリニック経営の成功にも直結します。</p>
