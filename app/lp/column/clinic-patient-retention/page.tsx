  ...
  return (
    <ArticleLayout slug={self.slug} breadcrumbLabel="マーケティング" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <p>患者の離脱には明確なパターンがあります。タイミングを把握し、先手を打つことが離脱防止の鍵です。セグメント配信の活用方法は<Link href="/lp/column/segment-delivery-repeat" className="text-sky-600 underline hover:text-sky-800">LINEセグメント配信でリピート率を向上させる方法</Link>でも解説しています。</p>
      ...
      <section>
        ...
        <p>LINEのステップ配信機能を使えば、来院後のフォローアップを完全に自動化できます。患者のLTV向上戦略の全体像は<Link href="/lp/column/clinic-patient-ltv" className="text-sky-600 underline hover:text-sky-800">患者LTV向上戦略</Link>をご覧ください。</p>
      ...
      <section>
        ...
        <p>一定期間来院していない患者に対する再来院促進キャンペーンは、離脱防止の切り札です。NPS調査を組み合わせて満足度も可視化する方法は<Link href="/lp/column/clinic-nps-survey" className="text-sky-600 underline hover:text-sky-800">NPS調査導入ガイド</Link>で紹介しています。</p>
