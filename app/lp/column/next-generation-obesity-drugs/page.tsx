  ...
  return (
    <ArticleLayout slug={self.slug} breadcrumbLabel="医薬品解説" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <img src="/lp/column/images/mounjaro/1823964357723877603-GVAF6B6bkAAWYaX.png" alt="次世代肥満症薬の開発パイプライン" className="rounded-xl my-4 w-full" />
      ...
      <section>
        ...
        <img src="/lp/column/images/mounjaro/1823964357723877603-GVAF6B8a8AA_Iag.png" alt="レタトルチドのトリプル作用機序" className="rounded-xl my-4 w-full" />
      </section>
      ...
      <section>
        ...
        <img src="/lp/column/images/mounjaro/1823964357723877603-GVAF6Bfa4AQaUQ_.jpg" alt="次世代肥満症薬の減量効果比較" className="rounded-xl my-4 w-full" />
      </section>
