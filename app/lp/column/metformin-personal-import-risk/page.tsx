  ...
  return (
    <ArticleLayout slug={self.slug} breadcrumbLabel="医薬品解説" keyPoints={keyPoints} toc={[]}>
      ...
      <section>
        ...
        <p>最近では、ダイエット目的で<Link href="/lp/column/mounjaro-complete-guide" className="text-sky-600 underline hover:text-sky-800">マンジャロ</Link>などのGLP-1受容体作動薬と併用するケースも増えています。特にマンジャロ7.5mg以上で体重減少が鈍ってきた場合に、メトホルミンを追加して代謝をもうひと押しする……という使い方ですね。</p>
      ...
      <section>
        ...
        <p>特に<Link href="/lp/column/mounjaro-blood-sugar-medications" className="text-sky-600 underline hover:text-sky-800">マンジャロと血糖関連薬の併用</Link>を検討している方は、必ず医師に相談して適切な用量を決めてもらいましょう。メトホルミンとGLP-1受容体作動薬の併用は効果的ですが、低血糖リスクなどの管理が必要です。</p>

        <p><Link href="/lp/column/glp1-medication-comparison" className="text-sky-600 underline hover:text-sky-800">GLP-1受容体作動薬の種類比較</Link>も参考にしてみてください。自分に合った治療の組み合わせを見つけるヒントになるはずです。</p>
      </section>
