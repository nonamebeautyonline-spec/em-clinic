  ...
  return (
    <ArticleLayout slug={self.slug} breadcrumbLabel="活用事例" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <p>
          オンライン診療の普及により、<strong>「忙しくて通院できない」という最大の受診障壁</strong>が取り除かれつつあります。40〜60代の働き世代男性 — SASのメインターゲット層 — はまさにこの障壁が最も高い層であり、オンライン診療との親和性が極めて高いといえます。オンライン診療の制度面については<Link href="/lp/column/online-clinic-regulations" className="text-sky-600 underline hover:text-sky-800">オンライン診療の制度と規制ガイド</Link>で詳しく解説しています。
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          月5〜8人の新規CPAP導入ペースで、<strong>12か月で60人・24か月で100人</strong>の管理患者に到達する想定です。SAS/CPAP患者は治療が長期にわたるため離脱率が低く、<strong>一度構築した患者基盤が長期的な安定収益を生み出す</strong>点がこの領域の大きな魅力です。不眠症のオンライン診療と組み合わせれば、睡眠領域全体で<Link href="/lp/column/insomnia-online-clinic-lope" className="text-sky-600 underline hover:text-sky-800">より広い患者層をカバー</Link>できます。
        </p>
      ...
      <section>
        ...
        <p>
          特にCPAP管理は、保険診療で月13,500円/人（指導管理料＋機器加算）、自費でも月8,000〜15,000円の安定収益を生み出すストック型ビジネスモデルです。保険なら50人で月67.5万円、100人で月135万円 — <strong>患者数の積み上げが経営基盤を着実に強化</strong>します。オンライン診療の全体像は<Link href="/lp/column/online-clinic-complete-guide" className="text-sky-600 underline hover:text-sky-800">オンライン診療完全ガイド</Link>で、開業コストの最適化は<Link href="/lp/column/clinic-fixed-cost-optimization" className="text-sky-600 underline hover:text-sky-800">固定費最適化ガイド</Link>で詳しく解説しています。
        </p>

        <h3 className="text-lg font-semibold text-gray-700 mt-6">関連記事</h3>
        <ul className="space-y-1 text-gray-700">
          <li>
            <Link href="/lp/column/insomnia-online-clinic-lope" className="text-sky-600 underline hover:text-sky-800">不眠症・睡眠薬のオンライン処方ガイド</Link> — 睡眠領域のもうひとつの柱、不眠症オンライン診療を解説
          </li>
          <li>
          ...
          <li>
            <Link href="/lp/column/self-pay-clinic-revenue-triple" className="text-sky-600 underline hover:text-sky-800">自費クリニック売上3倍の戦略</Link> — 自費診療の収益最大化ノウハウ
          </li>
          <li>
