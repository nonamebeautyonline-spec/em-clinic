  ...
  return (
    <ArticleLayout slug={self.slug} breadcrumbLabel="活用事例" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <p>他のクリニックのLINE活用事例については<Link href="/lp/column/clinic-line-case-studies" className="text-sky-600 underline hover:text-sky-800">LINE公式アカウント活用事例5選</Link>でも詳しく紹介しています。</p>
      </section>
      ...
      <section>
        ...
        <p>患者離脱を防ぐフォローアップ戦略の全体像は<Link href="/lp/column/clinic-patient-retention" className="text-sky-600 underline hover:text-sky-800">患者離脱防止のLINEフォローアップ</Link>で解説しています。</p>
      </section>
      ...
      <section>
        ...
        <p>LINE自動配信の設定方法については<Link href="/lp/column/clinic-line-automation" className="text-sky-600 underline hover:text-sky-800">LINE自動化完全ガイド</Link>で詳しく解説しています。</p>
      </section>
      ...
      <section>
        ...
        <p>Lオペ for CLINICは、眼科クリニックの特有の業務フローに対応した<Link href="/lp/features" className="text-sky-600 underline hover:text-sky-800">クリニック専用LINE運用プラットフォーム</Link>です。コンタクト処方管理・定期検診フォロー・術後ケアの自動化で、患者満足度と経営効率を同時に向上させます。</p>
      </section>
    </ArticleLayout>
  );
}
