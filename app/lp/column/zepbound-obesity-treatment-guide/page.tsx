  ...
  return (
    <ArticleLayout slug={self.slug} breadcrumbLabel="医薬品解説" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <img src="/lp/column/images/mounjaro/1823964357723877603-GVAF6B5agAAcslP.jpg" alt="ゼップバウンド（チルゼパチド）の概要" className="rounded-xl my-4 w-full" />
      ...
      <section>
        ...
        <p>「とにかく減量効果を重視するならゼップバウンド、心血管リスクも含めた総合管理ならウゴービ」という使い分けになりそうです。詳しくは<Link href="/lp/column/wegovy-obesity-treatment-guide" className="text-sky-600 underline hover:text-sky-800">ウゴービ完全ガイド</Link>もあわせてどうぞ。</p>
      </section>
      ...
      <section>
        ...
        <p>現実的には、ゼップバウンドの処方条件が厳しすぎて一般の方は保険で使えません。そのため、<strong>自費でマンジャロを使うという構図</strong>が依然として続いています。マンジャロについて詳しく知りたい方は<Link href="/lp/column/mounjaro-complete-guide" className="text-sky-600 underline hover:text-sky-800">マンジャロ完全ガイド</Link>をご覧ください。</p>
      </section>
      ...
      <section>
        ...
        <p>次世代の肥満症薬については<Link href="/lp/column/next-generation-obesity-drugs" className="text-sky-600 underline hover:text-sky-800">次世代肥満症薬まとめ</Link>で詳しく解説しています。また、マンジャロの基本は<Link href="/lp/column/mounjaro-complete-guide" className="text-sky-600 underline hover:text-sky-800">マンジャロ完全ガイド</Link>をどうぞ。</p>
      </section>
