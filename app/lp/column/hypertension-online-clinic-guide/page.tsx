  ...
  return (
    <ArticleLayout slug={self.slug} breadcrumbLabel="活用事例" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <p>第三に、家庭血圧計が広く普及しており、患者自身が血圧を測定してデータを共有できることです。日本高血圧学会のガイドライン（JSH2019）でも<strong>家庭血圧の測定が推奨</strong>されており、オンライン診療との親和性は制度面でも裏付けられています。高血圧を含む<Link href="/lp/column/lifestyle-disease-online-management" className="text-sky-600 underline hover:text-sky-800">生活習慣病のオンライン管理</Link>は、今後さらに重要性が増す領域です。</p>
      </section>
