  ...
  return (
    <ArticleLayout slug={self.slug} breadcrumbLabel="活用事例" keyPoints={keyPoints} toc={toc}>
      ...
      <section>
        ...
        <p>第三に、家庭血圧計が広く普及しており、患者自身が血圧を測定してデータを共有できることです。日本高血圧学会のガイドライン（JSH2019）でも<strong>家庭血圧の測定が推奨</strong>されており、オンライン診療との親和性は制度面でも裏付けられています。</p>
      </section>
      ...
      <section>
        ...
        <p>オンライン診療に<strong>適する患者</strong>は、降圧薬の服用により血圧が安定しているI度〜II度高血圧の患者、定期的に家庭血圧を測定できる患者、通院負担が大きい就労世代や遠方の患者です。3ヶ月以上対面で経過観察し、処方変更の必要がない安定期の患者が最も適しています。</p>
      ...
      <section>
        ...
        <p>加えて、オンライン診療の導入は<strong>患者の治療継続率を向上</strong>させるため、長期的なLTVの観点でもプラスに作用します。治療中断による患者離脱は、クリニック経営にとって最も大きな機会損失です。通院負担の軽減により継続率を10%改善できれば、年間の収益インパクトは相当なものになります。</p>
      </section>
