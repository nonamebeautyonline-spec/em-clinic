        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              "connect-src 'self' https://*.supabase.co https://api.line.me https://connect.squareup.com https://api.squareup.com https://*.upstash.io https://*.sentry.io https://*.ingest.sentry.io https://*.l-ope.jp https://api.anthropic.com",
